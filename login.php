...
$CURRENT_SET_EVENT_URL = ( $_SESSION['CURRENT_SET_EVENT_URL'] ) ? $_SESSION['CURRENT_SET_EVENT_URL'] : '';
$membership_no = ( $_SESSION['REG_NUMBER'] ) ? $_SESSION['REG_NUMBER'] : '';


$loginSuccessURL = ( $CURRENT_SET_EVENT_URL != '' ) ? $CURRENT_SET_EVENT_URL : 'myaccount.php';
...
if ( ( $membership_no != '' ) AND ( $CURRENT_SET_EVENT_URL != '' ) ) {
    $reg_url = SITE_ROOT . $CURRENT_SET_EVENT_URL; //  /event/conference-registration-form.php
	    ...
	    var formvalue = $("#frmlogin").serialize();
            ...
            $.ajax({
                ...
                success: function(msg) {     
                    ...
                    // console.log(spl_txt);
                    location.href = "https://www.insolindia.com/myaccount";
...
//                         {
//                           // alert("3--");
//                             location.href = "<?php echo SITE_ROOT.$loginSuccessURL; ?>";
//                         }
...
<div class="container">
    <div class="clearfix inner_page login">
    	<div class="row">
            ...
            <?php 
                if($CURRENT_SET_EVENT_URL) {
            ?>
                <div class="clr height15"></div>
                <p class="subsubHead">If you would like to register INSOL India: Delegate Registration as a Non Member, Please click on the link - 
                <a href="<?php echo SITE_ROOT . $CURRENT_SET_EVENT_URL; ?>">Register</a></p>
