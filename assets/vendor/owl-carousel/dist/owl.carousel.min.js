		...
		(function (t, e, i, s) {
			...
			(n.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
				...
				(n.prototype.thumbnail = function (e, i) {
					...
					return (
						e.wrap(
							'<div class="owl-video-wrapper"' + r + "></div>"
						),
						this._core.settings.lazyLoad &&
						...
						a.length
							...
							: void ("youtube" === i.type
									? ((o =
											"//web.archive.org/web/20201219032522/https://img.youtube.com/vi/" +
											i.id +
											"/hqdefault.jpg"),
									  p(o))
									: "vimeo" === i.type
									? t.ajax({
											type: "GET",
											url:
												"//web.archive.org/web/20201219032522/https://vimeo.com/api/v2/video/" +
												i.id +
												".json",
											jsonp: "callback",
											dataType: "jsonp",
									...
									: "vzaar" === i.type &&
									  t.ajax({
											type: "GET",
											url:
												"//web.archive.org/web/20201219032522/https://vzaar.com/api/videos/" +
												i.id +
												".json",
											jsonp: "callback",
											dataType: "jsonp",
					...
					this._playing ||
						...
						"youtube" === n.type
							? (i =
									...
									'" height="' +
									r +
									'" src="//web.archive.org/web/20201219032522/https://www.youtube.com/embed/' +
									n.id +
									"?autoplay=1&v=" +
									n.id +
							...
							: "vimeo" === n.type
							? (i =
									'<iframe src="//web.archive.org/web/20201219032522/https://player.vimeo.com/video/' +
									n.id +
									'?autoplay=1" width="' +
									o +
									'" height="' +
							...
							: "vzaar" === n.type &&
							  (i =
									...
									'"width="' +
									o +
									'" allowfullscreen mozallowfullscreen webkitAllowFullScreen src="//web.archive.org/web/20201219032522/https://view.vzaar.com/' +
									n.id +
		...
		(function (t, e, i, s) {
			...
			!!n("transition") &&
				...
				n("transform") &&
					...
					(t.support.transform3d = !!n("perspective")));
		})(window.Zepto || window.jQuery, window, document);
}
