...
}
{
	...
	!(function (i) {
		...
		function n(i) {
			...
			e.hasClass("webticker-init")
				? e.remove()
				: i.children().last().after(e);
		}
		function r(i, t) {
					...
					if ("reset" === s) a.html(e), l(a, !0);
						...
						if ((window.console, a.children("li").length < 1))
							...
							a
								...
								(f = t(a)),
								a.width(f + 200),
								a.find("li.webticker-init").length < 1 &&
									(c.startEmpty = !1),
								a.html(e),
		...
		i.fn.webTicker = function (t) {
			return d[t]
				...
				: "object" != typeof t && t
				? void i.error(
						"Method " + t + " does not exist on jQuery.webTicker"
				  )
