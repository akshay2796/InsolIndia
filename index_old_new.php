    ...
    <div class="container">
        <div class="col-md-8 col-sm-12 col-xs-12 index_about_left">
            ...
            <div class="index_about_left_cp">
                ...
                <p>INSOL India is an independent leadership body representing practitioners and other associated
                    professionals specialising in the fields of restructuring, insolvency and turnaround. It is an
                    association with an architecture that facilitates key stakeholders to come together and share
                    experiences while preserving their independence. <a
                        href="<?php echo SITE_ROOT . urlRewrite("insol-india.php"); ?>">read more</a></p>

                <a class="" target="_blank" href="<?php echo SITE_ROOT ?>downloads/insol-brochure.pdf"><img
                        src="images_insol/insol-brochure.jpg" width="40" style="margin-right:10px;" alt="" />Download
                    Brochure</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-md-6">
                ...
                <iframe width="100%" height="260" src="https://www.youtube.com/embed/U20eBum6M5I" frameborder="0"
...
<div class="clearfix ">
    ...
    <div class="container">
        ...
        <div class="row series_carosel">
            <div class="col-sm-6 col-md-6">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/9MORuRaZ3M4" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
                <h4 align="center">Liquidation in COVID – challenges</h4>
            </div>
            <div class="col-sm-6 col-md-6">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/xLrV60NchmE" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
                <h4 align="center">Roles, Responsibilities and Expectations of Indian Banks in the IBC process</h4>
            </div>
            <div class="col-sm-6 col-md-6">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/i7EVyPUps1Q" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
                <h4 align="center">How should Insolvency professionals tackle the new normal</h4>
            </div>
            <div class="col-sm-6 col-md-6">
                <iframe width="100%" height="315" src="https://www.youtube.com/embed/ZTASORC3D1w" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
