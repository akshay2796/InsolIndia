                    ...
                    if (parseInt(spl_txt[1]) == parseInt(1)) {
                        setTimeout(function() {
                            ...
                            window.location.href =
                                "<?php echo SITE_ROOT.'thankyou.php?url_key=new_registration' ?>";
                        }, 2000);
        ...
        <div class="col-md-10 col-sm-9 inner_page_right">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <form action="" name="frmReg" id="frmReg">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label>
                                                <input type="checkbox" value="Acedemic" name="i_am[]" id="i_am[]">
                                                Academic
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4" style="display: none1">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="member_name"
                                                    id="member_name" placeholder="Please Specify">
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>
                                        <h4 class="bluetxt"><input type="checkbox"> I am Insolvency Professional with
                                        </h4>
                                    </label>
                                    <div class="row">
                                        <div class="clr"></div>
                                        <div class="col-md-6">
                                            <label>please specify the name of Insolvency Professional
                                                Agency</label><input type="text" class="form-control" name="" id=""
                                                placeholder="">
                                        </div>
                                        <div class="col-md-6">
                                            <label><br>On number is<br></label><input type="text" class="form-control"
                                                name="" id="" placeholder="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>
                                        <h4 class="bluetxt"><input type="checkbox"> I am Insolvency Professional with
                                            Insolvency and Bankruptcy Board of India.</h4>
                                    </label>
                                    <div class="row">
                                        <div class="clr"></div>
                                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>
                                        <h4 class="bluetxt"><input type="checkbox"> I am a Young Practitioner. I confirm
                                            I have less than ten years experience in my profession mentioned in column
                                            1. </h4>
                                    </label>
                                    <div class="row">
                                        <div class="clr"></div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><input type="checkbox"> I have read and understood the terms and conditions
                                        of membership, accept and undertake to abide them.</label>
                                </div>
                            </div>

                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><input type="checkbox"> I am committed to develop the reputation and stature
                                        if insolvency profession. (Applicable to Insolvency, turnaround and
                                        restructuring professionals)</label>
                                </div>
                            </div>
                            <div class="col-xs-12">
                ...
                <div class="col-md-3 pull-right" style="border-left: 1px solid #ccc; padding-left: 30px;">
                    ...
                    <h3 class="subsubHead">You can also download the membership form and send it to INSOL India office.
                    </h3>
                    <br>
                    <a href="<?php echo SITE_ROOT ?>downloads/form.pdf" target="_blank" class="btn btn-primary">Download
                        Form</a>
