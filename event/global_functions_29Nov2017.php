                            ...
                            <table width="600" border="0" cellspacing="0" cellpadding="20" style="border: 12px solid #efefef; font-family: Helvetica, Arial, sans-serif" align="center">
                              <tbody>
                                    ...
                                    <tr>
                                        ...
                                        '.$telephone.' '.$mobile.' | E. '.$email.'<br><br>
                                                ...
                                                if(count($rowSP) > 0)
                                                {
                                                    $mMAIL .= "<table width='100%' border='0' cellspacing='0' cellpadding='0' style='border: 1px solid #ccc; font-family: arial;'>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td bgcolor='#ffffff' style='background: #ffffff; padding: 20px 0 20px 20px;'>";
                                                                        $s=1;
                                                                        foreach($rowSP as $rsSP)
                                                                        {
                                                                            ...
                                                                            if(intval($chk_file_sponsor) == intval(1))
                                                                            {
                                                                                ...
                                                                                $mMAIL .= "".$sponsor_url."<img src='".$display_image_sponsor."' height='48px' style='height: 48px; line-height:0px; display: inline-block; margin-bottom: 20px;' alt='".$company_name."'/>".$sponsor_url_end."";
                                                                                if(intval($s) < count($rowSP))
                                                                                {
                                                                                    $mMAIL .= "<img src='".SITE_IMAGES."20.jpg' width='20px' height='48px' style='height: 48px; width: 20px; line-height:0px; display: inline-block; margin-bottom: 20px;' alt=''/>";
                                                                                }
                                                                            }
                                                                            $s++;
                                                                        }     
