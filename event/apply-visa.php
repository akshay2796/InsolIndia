...
<?php 
  ...
  $connect = mysqli_connect("localhost","sabsoxpw_evisa","Hello@12345","sabsoxpw_evisa");
...
<?php include('include/header.php'); ?>
        ...
        <section id="news" class="blog_section bd-bottom padding">
            ...
            <div class="contact_form">
                            <h2 style="    border-bottom: 1px solid #ccc;padding-bottom: 15px;font-size: 20px;color: #ff9833;font-weight: bold;">e-Tourist Visa (eTV) Application</h2>
                           <br>
...
<h2 class="appli">Applicant 1</h2>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="" name="surname" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Name (exactly as in passport) <span>*</span></label>
                                        <input type="text" id="" name="pname" class="form-control" placeholder="" required="">
                                    </div>
                                </div>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id=" " name="gen" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Date of Birth (DD/MM/YYYY) <span>*</span></label>
                                        <input type="date" id=" " name="dob" class="form-control" placeholder="" required="">
                                    </div>
                                </div>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id=" " name="ctob" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Country of Birth <span>*</span></label>
                                        <input type="text" id=" " name="cob" class="form-control" placeholder="" required="">
                                    </div>
                                </div>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                      ...
                                      <div class="col-sm-6">
                                        ...
                                        <input type="text" id="" name="nati" class="form-control" placeholder="" required="">
                                    </div>
                                </div>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="" name="passno" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Place of Issue:<span>*</span></label>
                                        <input type="text" id="" name="placeissue" class="form-control" placeholder="" required="">
                                    </div>
                                </div>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="date" id="" name="doissue" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Date of Expiry (DD/MM/YYYY)<span>*</span></label>
                                        <input type="date" id="" name="doexo" class="form-control" placeholder="" required="">
                                    </div>
                                </div>
...
<h2 class="appli">Family Details</h2>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="" name="fathname" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Father's Place of Birth<span>*</span></label>
                                        <input type="text" id="" name="fathpob" class="form-control" placeholder="" required="">
                                    </div>
                                </div>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="" name="fathnati" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Mother's Name <span>*</span></label>
                                        <input type="text" id="" name="mothname" class="form-control" placeholder="" required="">
                                    </div>
                                </div>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="" name="mothpob" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Mother's Nationality<span>*</span></label>
                                        <input type="text" id="" name="mothnati" class="form-control" placeholder="" required="">
                                    </div>
                                </div>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="" name="spousname" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Place of Birth of Spouse <span>*</span></label>
                                        <input type="text" id="" name="pobspouce" class="form-control" placeholder="" required="">
                                    </div>
                                </div>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="" name="natiofspo" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Profession/Occupation Details of Applicant<span></span></label>
                                        <input type="text" id="" name="porffdetail" class="form-control" placeholder="" required="">
                                    </div>
                                </div>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="" name="empname" class="form-control" placeholder="" required="">
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" id="" name="jobtitle" class="form-control" placeholder="" required="">
                                    </div>
     ...
     <div class="form-group row">
                    ...
                    <span></span></label>
                                        ...
                                        <input type="text" id="" name="empaddress" class="form-control" placeholder="" required="">
                                    </div>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <label>Last Indian Visa No. (if any) <span>*</span>Write NA if you have not visited India before</label>
                                        <input type="text" id="" name="livisit" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Type of Visa<span>*</span>Write NA if you have not visited India before</label>
 ...
 <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <label>Place of Issue<span>*</span>Write NA if you have not visited India before</label>
                                        <input type="text" id="" name="placeofissue" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Date of Issue (DD/MM/YYYY)<span>*</span>Write NA if you have not visited India before</label>
                                        <input type="date" id="" name="dateofissue" class="form-control" placeholder="" required="">
                                    </div>
                                </div>  
   ...
   <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <label>Address of Last visit (if available):Write NA if you have not visited India before.</label>
                                        <input type="text" id="" name="addolv" class="form-control" placeholder="" required="">
                                    </div>
                                      <div class="col-sm-6">
                                        <label>Non EU countries visited in last 10 years:</label><br>
                                        <input type="text" id="" name="noneu" class="form-control" placeholder="" required="">
                                    </div>
                                </div>        
          ...
          <input name="image" value=""  id="imageupload"  type="file" required="">
                 ...
                 <div class="form-group row">
                                    <div class="col-sm-6">
                     <input type="checkbox" name="agree" value="accept" required=""> I Accept Terms and Conditions<br>
                                    </div>
