<?php 
    ...
    $fname = ( $_SESSION['FNAME'] ) ? $_SESSION['FNAME'] : '';
    $surname = ( $_SESSION['LNAME'] ) ? $_SESSION['LNAME'] : '';
    $email = ( $_SESSION['UEMAIL'] ) ? $_SESSION['UEMAIL'] : '';
   ...
   /*  if ( isset($_POST['submit_request'] ) ) {
        ...
        $is_previously_attendeds = ( $_POST['is_previously_attended'] ) ? $_POST['is_previously_attended'] : ''; //I enclose a cheque/draft/NEFT to the order of:
        ...
        // Send Mail to Support For Approval
