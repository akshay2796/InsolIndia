                        ...
                        if($numMENU > intval(0)){
                                                foreach($dsMENU as $menuLIST)
                                                {
                                                   ...
                                                   $menumasterURL = SITE_ROOT . urlRewrite("governance_list.php", array("url_key" => $menutypeURLKEY));
                                                    ...
                                                    if($menucountSUBTYPE == intval(0)) // to find if there is sub menu 
                                                    {
                                                 ?>

                                    				<li>
														<a href="<?php echo $menumasterURL; ?>" style="padding: 0px !important;" class="eqH"><div style="padding: 25px;"><?php echo $menutypeNAME; ?></div></a>
                                    				</li>
                                                ...
                                                <?php
                                                        ...
                                                        ?>
                                                        <li>
															<a href="<?php echo $submenumasterURL; ?>" style="padding: 0px !important;" class="eqH"><div style="padding: 25px;"><?php echo $submenutypeNAME; ?></div></a>
                                    				    </li>
                                                        <?php
                                                                        }
                                                    }
