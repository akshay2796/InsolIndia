...
ob_start();
include('header.php');
$master_url = trustme($_REQUEST['master_url']); 
$nameTITLE = getDetails(GOVERNANCE_TYPE_TBL, 'type_name', "status~~~url_key","ACTIVE~~~$master_url",'=~~~=~~~=', '', '' , ""); 

$URLKEY = trustme($_REQUEST['url_key']);

define("MAIN_PAGE", "governance_list.php");
...
<div class="container">
    <div class="clearfix inner_page">
        <div class="col-md-3 col-sm-4 led_team_left">
            ...
            <div class="team_back">
            	<p>
                	<a href="<?php echo SITE_ROOT . urlRewrite(MAIN_PAGE,  array("url_key" => $master_url)); ?>"><span data-hover="back to previous page">back to previous page</span></a>
                </p>
            </div>
        </div>
