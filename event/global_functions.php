...
function MailObject($TO=array(), $FROM="", $CC=array(), $BCC=array(), $SUBJECT="", $BODY="", $ATTACHMENTS = array(),$REPLYTO="")
{
    ...
    //$mail->AddAddress('111rohittiwari@gmail.com');
    if(trim($CC)!="")
    {
        $cc_array = explode(",", $CC);
                ...
                $MAIL_BODY .= '<td>';
                    $MAIL_BODY .= '<table width="600" border="0" cellspacing="0" cellpadding="20" style="border: 12px solid #efefef; font-family: Helvetica, Arial, sans-serif" align="center">';
                        $MAIL_BODY .= '<tbody>';
                            ...
                            else if($TYP == "EVENT_JOINER_REQUEST")
                            {
                                ...
                                if ( count($rsGET) > intval(0) )
                                {
                                    ...
                                    <tr>
                                        <td valign="top" style="height: 250px; color: #666; text-align: center; font-size: 16px;">
                                            <h1 style="color: #2E3192; font-size: 16px;">Thank you for your interest to join the event of INSOL India.</h1>
                                            We have received your event joining form. The request has been forwarded to event committee. We will let you know soon.
                                        </td>
                                    </tr>';
...
function getMailFormat($TYP,$ID,$WAT="")
{
    ...
    if ( strtoupper(trim($TYP)) == "EVENT_JOINER_REQUEST" )
    {
                        ...
                        <td>
                            <table width="600" border="0" cellspacing="0" cellpadding="20" style="border: 12px solid #efefef; font-family: Helvetica, Arial, sans-serif" align="center">
                              <tbody>
                                    ...
                                    <tr>
                                        <td bgcolor="#2E3192" style="color: #ffffff; padding: 12px 20px; text-align: center; font-size: 20px; font-weight: bold;">Following user submitted INSOL India: Delegate Registration form</td>
                                    </tr>
                                    <tr>
                                        <td valign="top" style="height: 250px; color: #333; text-align: left; font-size: 14px;">
                                        <h1 style="color: #2E3192; font-size:16px; margin-bottom: 5px;">'.$name.'</h1>';

                                        $mMAIL .= 'Address : '.$address.'<br><br>
                                        '.$phone.' | E. '.$email.'<br><br>
