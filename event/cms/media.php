...
$(function() {
    ...
    $(".setDefault").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo PAGE_AJAX; ?>",
            data: "type=setDefaultImage&image_id="+image_id+"&foldername="+foldername+"&media_id=<?php echo $ID; ?>",
            beforeSend: function(){
...
$(document).ready(function(){
    ...
    $.validator.addMethod('chkDataText', function (data){
        if( $.trim($("input[name=media_type]:checked").val()) == "CONTENT" && $.trim(CKEDITOR.instances.media_description.getData()) == "" )
        {
            return 0;
        }
        else
    ...
    $.validator.addMethod('chkDataUrl', function (data){
        if( $.trim($("input[name=media_type]:checked").val()) == "URL" && $.trim($("#ftype_url").val()) == "" )
        {
            return 0;
        }
        else
    ...
    $.validator.addMethod('chkDataFile', function (data){
        if( $.trim($("input[name=media_type]:checked").val()) == "FILE" && $.trim($("#ftype_file_validation").val()) == "" )
        {
            return 0;
        }
        else
...
<h1>
    Media <!--div class="addProductBox"><a href="<?php //echo PAGE_LIST;?>" class="backBtn">Go to List</a></div-->
</h1>
    ...
    <div class="containerPad">
        ...
        <div class="fullWidth">
            <div class="fullWidth">
                ...
                <input type="text" class="txtBox" name="media_name" id="media_name" value="<?php echo $media_name; ?>" maxlength="500" autocomplete="OFF" />
            </div>              
        </div>
        <div class="fullWidth noGap">
            <div class="width4">
                ...
                <div class="txt3Box">
                    <input type="text" class="titleTxt txtBox" name="media_from_date" id="media_from_date" value="<?php echo $media_from_date; ?>" maxlength="12" placeholder="Date" style="width: 90px;"  autocomplete="OFF" />&nbsp;&nbsp;
                </div>  
            </div>       
            <div class="width4">
            	<label class="mainLabel">Publisher <span></span> </label>
                <input type="text" class="titleTxt txtBox" name="media_publisher" id="media_publisher" value="<?php echo $media_publisher; ?>" maxlength="250" placeholder="Publisher"  />&nbsp;&nbsp;
        ...
        <div class="fullWidth">
            ...
            <div class="">
                <label class="radioGroup"><input type="radio" name="media_type" class="media_type" value="CONTENT" <?php if( trim($media_type) == 'CONTENT') { echo " checked "; } ?> checked="checked"/> Content</label>       
                <label class="radioGroup"><input type="radio" name="media_type" class="media_type" value="URL" <?php if( trim($media_type) == 'URL') { echo " checked "; } ?> /> Url</label>
                <label class="radioGroup"><input type="radio" name="media_type" class="media_type" value="FILE" <?php if( trim($media_type) == 'FILE') { echo " checked "; } ?> /> File</label>
            </div>
        </div>
         
        
        <div class="fullWidth div_file validateMsg" <?php if( trim($media_type) != 'FILE') { echo " style='display: none;' "; } ?>>
        ...
        <div class="fullWidth div_url" <?php if( trim($media_type) != 'URL') { echo " style='display: none;' "; } ?>>
            ...
            <input type="text" class="titleTxt txtBox" name="ftype_url" id="ftype_url" value="<?php echo $media_url; ?>" maxlength="1000">
        ...
        <div class="div_content" <?php if( trim($media_type) != 'CONTENT') { echo " style='display: none;' "; } ?>>
            ...
            <div class="fullWidth validateMsg">        	
                ...
                <textarea class="txtBox" name="media_short_description" id="media_short_description" data-maxsize="" data-output="status1" wrap="virtual" style="height:100px;"><?php echo $media_short_description; ?></textarea>   
            ...
            <div class="fullWidth validateMsg">
                <textarea name="media_description" id="media_description" style="width:90%; height:230px; float:left;"><?php echo $media_description; ?></textarea>
                <script>
