                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                            <tr class="expiredCoupons trhover">
                                                ...
                                                <td align="center" width="5%">
                                                    <div id="INPROCESS_STATUS_1_<?php echo $news_id; ?>"
                                                        style="display: none;"></div>
                                                    <div id="INPROCESS_STATUS_2_<?php echo $news_id; ?>">
                                                        <a href="javascript:void(0);" value="<?php echo $news_id; ?>"
...
if ($DISPLAY_IMG != '') {
            ...
            ?>
                                                ...
                                                <td align="center" width="15%">
                                                    <div id="INPROCESS_SETDISPLAY_1_<?php echo $news_id; ?>"
                                                        style="display: none;"></div>
...
if ($display_on_top == intval(1)) {
            ...
            ?>
                                                ...
                                                <td align="center" width="10%">
                                                    <div id="INPROCESS_DELETE_1_<?php echo $news_id; ?>"
                                                        style="display: none;"></div>

                                                    <div id="INPROCESS_DELETE_2_<?php echo $news_id; ?>">
                                                        <a href="<?php echo PAGE_MAIN; ?>?id=<?php echo $news_id; ?>"
