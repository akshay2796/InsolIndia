...
function listData()
{
    ...
    $SQL = "";
    $SQL .= " SELECT A.* ";
    $SQL .= " FROM " . NEWS_TBL . " as A WHERE  A.status <> 'DELETE' $search ORDER BY position, news_id desc ";
            ...
            <td class="list_table" valign="top">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" border='0'>
                    <tr>
                        ...
                        <th width="55%" align="left">Title</th>
...
if (trim($status) == 'ACTIVE') {
            ...
            ?>
                                            ...
                                            <td width="50%" align='left'>
                                                <?php echo ucwords(strtolower($news_title)); ?>
                                            </td>
