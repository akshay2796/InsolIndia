                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                <tr class="expiredCoupons trhover" >
                                                    ...
                                                    <td align="center" width="5%"> 
                                                        <input type="checkbox" class="cb-element" name="chk[]" value="<?php echo $subtype_id; ?>" />
                                                    </td>
                                                    
                                                    <td align="center" width="5%">
                                                       <div id="INPROCESS_STATUS_1_<?php echo $subtype_id; ?>" style="display: none;"></div>
                                                        <div id="INPROCESS_STATUS_2_<?php echo $subtype_id; ?>"  >
                                                            <a href="javascript:void(0);" value="<?php  echo $subtype_id; ?>" myvalue="<?php echo $STATUSnowaction; ?>" class="setStatus">
                                                                <img 
                                                                <?php 
                                                    ...
                                                    <td align="center" width="10%">
                                                       <div id="INPROCESS_DELETE_1_<?php echo $subtype_id; ?>" style="display: none;"></div>
                                                       
                                                       <div id="INPROCESS_DELETE_2_<?php echo $subtype_id; ?>">
                                                            <a href="<?php echo PAGE_MAIN; ?>?id=<?php echo $subtype_id; ?>" class="modifyData img_btn">
                                                            ...
                                                            {
                                                            ?>
                                                                <a href="javascript:void(0);" value="<?php  echo $subtype_id; ?>" class="deleteData img_btn">
