                        ...
                        ?>     
                            ...
                            <tr class="expiredCoupons trhover">
                                 <td align="center" width="3%"> 
                                    <input type="checkbox" class="cb-element" name="chk[]" value="<?php echo $homegirl_id; ?>" />
                                </td>
                                ...
                                <td>
                                	<h3 class="couponType">
                                        <a class="previewBookReview" href="javascript: void(0);" bid=<?php echo $member_id; ?>><?php echo $member_name; ?></a>
                                   </h3>
                                </td>  
                                <td>
                                    <h3 class="couponType">
                               ...
                               <td>
                                ...
                                <td align="center" >
                                   ...
                                   <div id="INPROCESS_DELETE_2_<?php echo $member_id; ?>"  >
                                        <a href="<?php echo PAGE_MAIN; ?>?ID=<?php echo base64_encode(intval($member_id)); ?>" class="modifyData img_btn">
                                            <img src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH; ?>view.png" border="0" title="View" alt="View" />
                                        </a>  
                                        <?php
                                        if( intval($CHK) == intval(0) )
                                        {
