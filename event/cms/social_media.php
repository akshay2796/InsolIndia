...
$(document).ready(function(){
               ...
               success: function(msg){                   
                   ...
                   setTimeout(function(){
                        ...
                        if( parseInt(spl_txt[1]) == parseInt(1) )
                        {
                            ...
                            $("#con").val("");
                            $("#MOD").html("Modify");
                            $("#socialmedia_name").val(""); 
                            $("#socialmedia_link").val(""); 
    ...
    $.fn.modifyData = function() {
        ...
        var socialmedia_id = args.socialmedia_id || "";
        
        $.ajax({
            
            type: "POST",
            url: "<?php echo PAGE_AJAX; ?>",
            data: "type=modifyData&socialmedia_id=" + socialmedia_id,
            beforeSend: function(){  
                $("html, body").animate({ scrollTop: 0 }, "slow");
                $("#INPROCESS_DELETE_2_" + socialmedia_id).hide();
                $("#INPROCESS_DELETE_1_" + socialmedia_id).html("<img src='<?php echo CMS_INCLUDES_IMAGES_RELATIVE_PATH; ?>loader-small.gif' border='0'>").show();        
            },
            success: function(msg){
               ...
               // return false;
                ...
                $("#INPROCESS_DELETE_1_" + socialmedia_id).html("").hide();
                $("#INPROCESS_DELETE_2_" + socialmedia_id).show();
                ...
                $("#socialmedia_name").val(spl_txt[2]);
                $("#socialmedia_link").val(spl_txt[3]);
...
<div class="addWrapper master">
    <div class="boxHeading expendBtn"> <span id="MOD">Modify</span> <a href="javascript:void(0)" class=""></a></div>
    ...
    <div class="containerPad expendableBox">
        <div class="fullWidth noGap">                    	
            <div class="width3">
                ...
                <input type="text" class="txtBox" value="" name="socialmedia_name" id="socialmedia_name" maxlength="150" AUTOCOMPLETE = "OFF" />
            </div>         
        </div><!--fullWidth end--> 
       ...
       <div class="fullWidth noGap">                    	
            <div class="width3">
                ...
                <div class="exlink" >
                    <input type="text" class="txtBox" value="" name="socialmedia_link" id="socialmedia_link" maxlength="150" AUTOCOMPLETE = "OFF" />
                </div>
            </div>         
        </div><!--fullWidth end--> 
