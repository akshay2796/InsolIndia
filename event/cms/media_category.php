...
$(document).ready(function(){
    ...
    $.fn.modifyData = function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo PAGE_AJAX; ?>",
            data: "type=modifyData&category_id=" + category_id,
            beforeSend: function(){  
                $("html, body").animate({ scrollTop: 0 }, "slow");
                $("#INPROCESS_DELETE_2_" + category_id).hide();
                $("#INPROCESS_DELETE_1_" + category_id).html("<img src='<?php echo CMS_INCLUDES_IMAGES_RELATIVE_PATH; ?>loader-small.gif' border='0'>").show();        
            },
            success: function(msg){
                
                //alert(msg)
                   
                $("#INPROCESS_DELETE_1_" + category_id).html("").hide();
                $("#INPROCESS_DELETE_2_" + category_id).show();
                ...
                $("#category_name").val(spl_txt[2]);       
                $("#meta_title").val(spl_txt[3]);   
                $("#meta_keyword").val(spl_txt[4]);   
                $("#meta_description").val(spl_txt[5]);   
                if($.trim(spl_txt[6]) == "ACTIVE") {
                    $('input:radio[name=status]')[0].checked = true;
                } else {
    ...
    <div class="containerPad expendableBox">
        <div class="fullWidth noGap">                    	
            <div class="width3">
                ...
                <input type="text" class="txtBox" value="" name="category_name" id="category_name" autocomplete="OFF" />
            </div> 
            <div class="width3">
                <label class="mainLabel">Status <span>*</span></label>
            	<label class="radioGroup"><input type="radio" name="status" value="ACTIVE" checked='' /> Active</label>
        		<label class="radioGroup"><input type="radio" name="status" value="INACTIVE" /> Inactive </label>           	
            </div>        
        </div><!--fullWidth end-->    
        ...
        <div class="fullWidth">
        	<div class="fullWidth">  
                ...
                <input type="text" class="titleTxt txtBox" name="meta_title" id="meta_title" value="" maxlength="250" autocomplete="OFF">
            </div>
            <div class="fullWidth">  
                <label class="mainLabel">Meta Keyword </label>
                <input type="text" class="titleTxt txtBox" name="meta_keyword" id="meta_keyword" value="" maxlength="350" autocomplete="OFF">
            </div>
            <div class="fullWidth">  
            	<label class="mainLabel">Meta Description </label>
                <input type="text" class="titleTxt txtBox" name="meta_description" id="meta_description" value="" maxlength="250" autocomplete="OFF">
            </div>
        </div> 
