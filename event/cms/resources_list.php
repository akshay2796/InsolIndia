...
$CID = intval($_REQUEST['rcid']);

$QRY = "";
$QRY = " select * from ".RESOURCES_CATEGORY_TBL." AS s where s.status= 'ACTIVE' and category_id=:category_id";
//echo "==".$QRY.$CID;
//exit();
...
<h1>Resources List <span> - <?php echo $category_name;?></span> <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>?CID=<?php echo base64_encode(intval($CID));?>" class="backBtn">Add New</a></div></h1>
