                        ...
                        ?>     
                            ...
                            <tr class="expiredCoupons trhover">
                                 <td align="center" width="3%"> 
                                    <input type="checkbox" class="cb-element" name="chk[]" value="<?php echo $resources_id; ?>" />
                                </td>
                                
                                <td align="center">
                                   <div id="INPROCESS_STATUS_1_<?php echo $resources_id; ?>" style="display: none;"></div>
                                    <div id="INPROCESS_STATUS_2_<?php echo $resources_id; ?>"  >
                                        <a href="javascript:void(0);" value="<?php  echo $resources_id; ?>" myvalue="<?php echo $STATUSnowaction; ?>" class="setStatus">
                                            <img 
                                            <?php 
                                ...
                                <td>
                                	<h3 class="couponType" style="max-width: 100%;">
                                        <a class="previewBookReview" href="javascript: void(0);" bid=<?php echo $resources_id; ?>><?php echo $resources_name; ?></a>
                                   </h3>
                                </td>  
                                <td>
                                ...
                                <td align="center" >
                                   ...
                                   <div id="INPROCESS_DELETE_2_<?php echo $resources_id; ?>"  >
                                        <a href="<?php echo PAGE_MAIN; ?>?ID=<?php echo base64_encode(intval($resources_id)); ?>" class="modifyData img_btn">
                                        ...
                                        {
                                        ?>
                                            <a href="javascript:void(0);" value="<?php  echo $resources_id; ?>" class="deleteData img_btn">
