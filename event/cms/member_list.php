...
$QRY = "";
$QRY = " select * from ".MEMBER_TYPE_TBL." AS s where s.status= 'ACTIVE' and type_id=:type_id";
//echo "==".$QRY.$atid;
$stmSec = $dCON->prepare($QRY);
$stmSec->bindParam(":type_id",$mtid);
$stmSec->execute();
...
$(document).ready(function(){
     ...
     $.fn.listData = function() {
        ...
        $.ajax({
            ...
            data: "type=listData&mtid=" + "<?php echo $mtid; ?>&" + search_val + "&page=" + pageNo,
            beforeSend: function(){  
...
<h1>Member List <span> - <?php echo $type_name;?></span> <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>?mtid=<?php echo $mtid;?>" class="backBtn">Add New</a></div></h1>
