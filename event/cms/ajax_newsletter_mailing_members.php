                            ...
                            <tr class="expiredCoupons trhover" >
                                ...
                                <td align="center" >                           
                                   ...
                                   <div id="INPROCESS_DELETE_2_<?php echo $mail_id; ?>"  >
                                        ...
                                        <a href="<?php echo PAGE_MAIN;?>?con=modify&id=<?php echo $mail_id; ?>" class="img_btn viewDetail" title="Modify">
                                        ...
                                        {
                                        ?>
                                            <a href="javascript:void(0);" value="<?php  echo $mail_id; ?>" class="deleteData img_btn">
