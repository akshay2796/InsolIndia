...
$(document).ready(function(){
    ...
    function loadUrl()
    {
        ...
        var search_governor_post = queryString['search_governor_post'] || "";
        var search_governor_name = queryString['search_governor_name'] || "";
         
        
        var search_val = "search_governor_post=" + search_governor_post;
        search_val = search_val + "&search_governor_name=" + search_governor_name;
    ...
    $("#reset").click(function(){ 
     ...
     $.fn.loadSamePageViaAjax = function() {
        ...
        $("#search_governor_post").val("");
        $("#search_governor_name").val("");
...
<h1>Board of Governors List <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>" class="backBtn">Add New</a></div></h1>
        ...
        <form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
            <div class="fullWidth noGap">
                <div class="width4">
                    ...
                    <input type="text" class="txtBox" name="search_governor_name" id="search_governor_name" value="" maxlength="100"/>
                </div>
                 
                 <div class="width4">
                    <label class="mainLabel">Post <span></span></label>
                    <input type="text" class="txtBox" value="" name="search_governor_post" id="search_governor_post" AUTOCOMPLETE = "OFF"/>
                </div>
