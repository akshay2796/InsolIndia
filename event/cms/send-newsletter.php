...
$group_mail_chk = $_SESSION['group_members_chk'];
    ...
    <div class="addWrapper" style="min-height:300px;">
        <div class="containerPad">
            <div class="fullWidth">
                ...
                <?php
                if(intval($group_mail_chk) == intval(1))
                { 
                ?>
                    <div style="color:#1E6D42;font-size: 16px;">Mailing List - Mail successfully sent </div>
                <?php
                } 
                ?>
