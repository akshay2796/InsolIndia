...
$(document).ready(function(){
    ...
    function loadUrl()
    {
        ...
        var search_reference = queryString['search_reference'] || "";
        var search_fdate = queryString['search_fdate'] || "";    
        var search_tdate = queryString['search_tdate'] || "";
                   
        
        var search_val = "search_reference=" + search_reference;
...
<h1>General Newsletter List <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>" class="backBtn">Add New</a></div></h1>
    ...
    <div class="containerPad">
        <form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
            <div class="fullWidth noGap">
                <div class="width4">
                	<label class="mainLabel">Reference</label>                             
                    <input type="text" class="txtBox" name="search_reference" id="search_reference" value="" maxlength="100"/>
                </div>
