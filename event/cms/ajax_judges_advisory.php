                                        ...
                                        <tr class="expiredCoupons trhover">
                                            ...
                                            <td align="center" width="5%">
                                                <input type="checkbox" class="cb-element" name="chk[]"
                                                    value="<?php echo $judges_ar_id; ?>" />
                                            </td>

                                            <td align="center" width="5%">
                                                <div id="INPROCESS_STATUS_1_<?php echo $judges_ar_id; ?>"
                                                    style="display: none;"></div>
                                                <div id="INPROCESS_STATUS_2_<?php echo $judges_ar_id; ?>">
                                                    <a href="javascript:void(0);" value="<?php echo $judges_ar_id; ?>"
...
if ($DISPLAY_IMG != '') {
            ...
            ?>
                                            ...
                                            <td align="center" width="10%">
                                                <div id="INPROCESS_DELETE_1_<?php echo $judges_ar_id; ?>"
                                                    style="display: none;"></div>

                                                <div id="INPROCESS_DELETE_2_<?php echo $judges_ar_id; ?>">
                                                    <a href="<?php echo PAGE_MAIN; ?>?id=<?php echo $judges_ar_id; ?>"
