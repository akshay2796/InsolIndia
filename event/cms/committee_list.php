...
$QRY = "";
$QRY = " select * from ".COMMITTEES_TYPE_TBL." AS s where s.status= 'ACTIVE' and type_id=:type_id";
//echo "==".$QRY.$atid;
...
$(document).ready(function(){
    ...
    function loadUrl()
    {
        ...
        var search_committee_post = queryString['search_committee_post'] || "";
        var search_committee_name = queryString['search_committee_name'] || "";
         
        
        var search_val = "search_committee_post=" + search_committee_post;
        search_val = search_val + "&search_committee_name=" + search_committee_name;
    ...
    $("#reset").click(function(){ 
     ...
     $.fn.loadSamePageViaAjax = function() {
        ...
        $("#search_committee_post").val("");
        $("#search_committee_name").val("");
...
<h1>Committee Member List <span> - <?php echo $type_name;?></span> <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>?ctid=<?php echo $ctid;?>" class="backBtn">Add New</a></div></h1>
        ...
        <form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
            <div class="fullWidth noGap">
                ...
                <div class="width4">
                    ...
                    <input type="text" class="txtBox" name="search_committee_name" id="search_committee_name" value="" maxlength="100"/>
                </div>
                 
                 <div class="width4">
                    <label class="mainLabel">Post <span></span></label>
                    <input type="text" class="txtBox" value="" name="search_committee_post" id="search_committee_post" AUTOCOMPLETE = "OFF"/>
                </div>
