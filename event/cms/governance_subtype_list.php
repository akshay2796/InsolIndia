...
$(document).ready(function(){
    ...
    function loadUrl()
    {
        ...
        var search_governance_type = queryString['search_governance_type'] || "";
       // var search_fdate = queryString['search_fdate'] || "";    
       // var search_tdate = queryString['search_tdate'] || "";
                   
        
        var search_val = "search_governance_type=" + search_governance_type;
...
<h1>Governance Subtype List <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>" class="backBtn">Add New</a></div></h1>
    ...
    <div class="containerPad">
        <form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
            <div class="fullWidth noGap">
               <!-- <div class="width4">
                    <label class="mainLabel">Governance Type</label>                             
                    <input type="text" class="txtBox" name="search_governance_type" id="search_governance_type" value="" maxlength="100"/>
                    
                </div> -->
                 <div class="width4">
                    <label class="mainLabel">Governance Type<span> *</span></label>   
                    <select name="search_governance_type" id="search_governance_type" data-placeholder="Select Type" class="chzn-select" required >                          
                        <option value=""></option>                                      
