...
$(document).ready(function(){
    ...
    function loadUrl()
    {
        ...
        var search_judges_ar_post = queryString['search_judges_ar_post'] || "";
        var search_judges_ar_name = queryString['search_judges_ar_name'] || "";
         
        
        var search_val = "search_judges_ar_post=" + search_judges_ar_post;
        search_val = search_val + "&search_judges_ar_name=" + search_judges_ar_name;
    ...
    $("#reset").click(function(){ 
     ...
     $.fn.loadSamePageViaAjax = function() {
        ...
        $("#search_judges_ar_post").val("");
        $("#search_judges_ar_name").val("");
...
<h1>Judges Advisory Roundtable List <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>" class="backBtn">Add New</a></div></h1>
        ...
        <form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
            <div class="fullWidth noGap">
                <div class="width4">
                    ...
                    <input type="text" class="txtBox" name="search_judges_ar_name" id="search_judges_ar_name" value="" maxlength="100"/>
                </div>
                 
                 <div class="width4">
                    <label class="mainLabel">Post <span></span></label>
                    <input type="text" class="txtBox" value="" name="search_judges_ar_post" id="search_judges_ar_post" AUTOCOMPLETE = "OFF"/>
                </div>
