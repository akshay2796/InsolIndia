...
$(document).ready(function(){
    ...
    function loadUrl()
    {
        ...
        var search_title_name = queryString['search_title_name'] || "";
        var search_fdate = queryString['search_fdate'] || "";    
        var search_tdate = queryString['search_tdate'] || "";
                   
        
        var search_val = "search_title_name=" + search_title_name;
...
<h1>Draft Insolvency Best Practices List <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>" class="backBtn">Add New</a></div></h1>
        ...
        <form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
            <div class="fullWidth noGap">
                <div class="width4">
                    ...
                    <input type="text" class="txtBox" name="search_title_name" id="search_title_name" value="" maxlength="100"/>
                </div>
