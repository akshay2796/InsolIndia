        ...
        <script language="javascript" type="text/javascript">
            $(document).ready(function(){
                ...
                $(".deleteData").click(function(){
                    ...
                    $(this).deleteData({socialmedia_id: socialmedia_id});  
                });
                ...
                $(".modifyData").click(function(){
                    ...
                    $(this).modifyData({socialmedia_id: socialmedia_id});
                        	...
                        	<tr>
                            	<td align="left" width="20">
                                    ...
                                    if( intval($CHK) == intval(0) )
                                    {
                                        $CK_COUNTER++;
                                    ?>
                                        <input type="checkbox" class="cb-element" name="chk[]" value="<?php echo $socialmedia_id; ?>" />
                                    <?php
                                    }
                                    else
                                    {
                                ...
                                <td width="30" class="statusTd">
                                	<div id="INPROCESS_STATUS_1_<?php echo $socialmedia_id; ?>" style="display: none;"></div>
                                    <div id="INPROCESS_STATUS_2_<?php echo $socialmedia_id; ?>"  >
                                        <?php 
                                        if( trim($status) == 'ACTIVE') 
                                        { 
                                        ?>
                                            <a href="javascript:void(0);" value="<?php  echo $socialmedia_id; ?>" myvalue="<?php echo $STATUSnowaction; ?>" class="setStatus"><img src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH; ?>active.png" /></a>
                                        <?php 
                                        }
                                        elseif( trim($status) == 'INACTIVE') 
                                        { 
                                        ?>
                                           <a href="javascript:void(0);" value="<?php  echo $socialmedia_id; ?>" myvalue="<?php echo $STATUSnowaction; ?>" class="setStatus"><img src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH; ?>inactive.png" /></a>
                                        <?php 
                                        }
                                        ?>   
                                    </div>
                                 ...
                                 <td align="right">                                
                                    ...
                                    <div id="INPROCESS_DELETE_1_<?php echo $socialmedia_id; ?>" style="display: none;"></div>
                                    <div id="INPROCESS_DELETE_2_<?php echo $socialmedia_id; ?>"  >
                                        <a href="javascript:void(0);" value="<?php echo $socialmedia_id; ?>" class="modifyData cmsIcon" title="Modify">
                                        <img src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH; ?>edit_icon.png" border="0" title="Modify" alt="Modify" /></a> 
                                        <?php
                                        if( intval($CHK) == intval(0) )
                                        {
                                        ?>
                                            <a href="javascript:void(0);" value="<?php  echo $socialmedia_id; ?>" class="deleteData cmsIcon">
