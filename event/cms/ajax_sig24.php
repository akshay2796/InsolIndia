...
if (intval($dA) > intval(0)) {
        ...
        <tr>
            <td class="list_table" valign="top">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" border='0'>
                    <tr>
                        <th width="5%"><?php if ((intval($dA) > intval(0))) {?><input type="checkbox" name="chk_all"
                                value="1" id="chk_all" /><?php }?></th>
                                        ...
                                        <tr class="expiredCoupons trhover">
                                            ...
                                            <td width="5%">
                                                <input type="checkbox" class="cb-element" name="chk[]"
                                                    value="<?php echo $sig24_id; ?>" />
                                            </td>

                                            <td align="center" width="5%">
                                                <div id="INPROCESS_STATUS_1_<?php echo $sig24_id; ?>"
                                                    style="display: none;"></div>
                                                <div id="INPROCESS_STATUS_2_<?php echo $sig24_id; ?>">
                                                    <a href="javascript:void(0);" value="<?php echo $sig24_id; ?>"
...
if ($DISPLAY_IMG != '') {
                ?>
                                                <img src="<?php echo $DISPLAY_IMG; ?>" alt="" width="40"
                                                    style="max-width: 100%;" />
                                                <?php
}
            ?>
                                            ...
                                            <td align="center" width="10%">
                                                <div id="INPROCESS_DELETE_1_<?php echo $sig24_id; ?>"
                                                    style="display: none;"></div>

                                                <div id="INPROCESS_DELETE_2_<?php echo $sig24_id; ?>">
                                                    <a href="<?php echo PAGE_MAIN; ?>?id=<?php echo $sig24_id; ?>"
