            ...
            <script language="javascript" type="text/javascript">
                $(document).ready(function(){                                               
                    ...
                    $(".setPresident").live("click", function() {
                        ...
                        $(this).setPresident({ID: ID,VAL:VAL});  
                     }); 
                        ...
                        foreach($row as $rs)
                        {
                            ...
                            <tr class="expiredCoupons trhover" >
                                ...
                                <td align="center" width="5%"> 
                                    <input type="checkbox" class="cb-element" name="chk[]" value="<?php echo $president_id; ?>" />
                                </td>
                                
                                <td align="center" width="5%">
                                   <div id="INPROCESS_STATUS_1_<?php echo $president_id; ?>" style="display: none;"></div>
                                    <div id="INPROCESS_STATUS_2_<?php echo $president_id; ?>"  >
                                        <a href="javascript:void(0);" value="<?php  echo $president_id; ?>" myvalue="<?php echo $STATUSnowaction; ?>" class="setStatus">
                                            <img 
                                            <?php 
                                ...
                                <td align="center" width="15%">
                                    ...
                                    <div id="INPROCESS_HOME_2_<?php echo $president_id; ?>"  >
                                        ...
                                        { 
                                        ?>
                                            <a href="javascript:void(0);" value="<?php echo $president_id; ?>" myvalue="<?php echo $PRESIDENTnowaction; ?>" class="">
                                              <img  src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH; ?>set.png" title="Current President" alt="Current President" />
                                            </a>
                                        <?php
                                        }
                                        else
                                        {                                                           
                                        ?>
                                            <a href="javascript:void(0);" value="<?php echo $president_id; ?>" myvalue="<?php echo $PRESIDENTnowaction; ?>" class="setPresident">
                                                 <img src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH; ?>unset.png" title="Set" alt="Set" />
                                ...
                                <td align="center" width="10%">
                                   ...
                                   <div id="INPROCESS_DELETE_2_<?php echo $president_id; ?>">
                                        <a href="<?php echo PAGE_MAIN; ?>?id=<?php echo $president_id; ?>" class="modifyData img_btn">
                                        ...
                                        {
                                        ?>
                                            <a href="javascript:void(0);" value="<?php  echo $president_id; ?>" class="deleteData img_btn">
