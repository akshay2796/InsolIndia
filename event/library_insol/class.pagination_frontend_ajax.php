        ...
        if($noOfPages>1) 
        {
            if(isset($pageNo))
            {
               ...
               // $page.="<a class='paging' href='javascript:pagination($prev_loop);'>Prev</a>";
                $page.="<span><a href='javascript:void(0);' id = '$one' class='paging'>First</a></span>&nbsp;";
                $page.="<span><a href='javascript:void(0);' id = '$prev_loop' class='paging'>Prev 10</a></span>";
                }
            }
            $x=0;
            $j=1;
            ...
            if($pageNo!=$last && $noOfPages>10)
            {
                ...
                if($ll!=$loop)
                {
                    ...
                    $page.="<a class='paging' href='javascript:void(0);' id = '$pp'>Next 10</a>&nbsp;";
                    $page.="<a class='paging' href='javascript:void(0);' id = '$ll'>Last</a>";
                }                
            }
