            ...
            <div class="col-md-10 col-sm-9 inner_page_right">
                ...
                <form method="POST" name="conference_form" id="conference_form" >
                    ...
                    <div style="margin-left: -225px;">
                        ...
                        <p class="rate" style="margin-left:20%!important;">After 15 October 2018</p>
                        ...
                        <?php if ( $membership_no != '' ) { ?> 
                            ...
                            <p class="rate" style="margin-left:20%!important;">Rs. 18,800/- </p>
                        <?php   }   ?>
                        ...
                        <!-- <?php if ( $membership_no == '' ) { ?>
                            ...
                            <p class="rate" style="margin-left:20%!important;">Rs. 23,600/- <!-- <input type="checkbox" name="non_member_fees_before_15" id="non_member_fees_after_15" > --></p>
                        <?php   }   ?>
