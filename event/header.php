...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" type="image/png" href="<?php echo SITE_IMAGES; ?>favicon_icon.png">
        ...
        <link rel="stylesheet" href="<?php echo SITE_CSS; ?>slick.css" />
        <link rel="stylesheet" href="<?php echo SITE_CSS; ?>lightgallery.css" />
        <link rel="stylesheet" href="<?php echo SITE_CSS; ?>main.css" />
        <link rel="stylesheet" href="<?php echo SITE_CSS; ?>responsive.css" />
            
        <script src="<?php echo SITE_JS; ?>jquery.min.js"></script>
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        <script src="<?php echo SITE_JS; ?>lightgallery.min.js"></script>
        <script src="<?php echo SITE_JS; ?>lg-video.min.js"></script>
        <script>
								...
								<ul>
									<?php if(LOGGED_IN == "YES") {  ?> 
                                        <li style="position: relative">
                                            <a href="<?php echo SITE_ROOT . urlRewrite("myaccount.php"); ?>" class="btn-myaccount myaccountButton">My Account</a>                            
                                        </li>
                                    ...
                                    { ?> 
                                        ...
                                        <li style="position: relative;">
                                            <a href="<?php echo SITE_ROOT . urlRewrite("login.php"); ?>" class="btn-myaccount myaccountLogin">Member Login</a>
                                        </li>                             
                                    <?php 
                                    } 
                                    ?>
									...
									<li>
										<a href="<?php echo SITE_ROOT . urlRewrite("events.php"); ?>">Events</a>
									</li>
									<li>
            	...
            	<div class="container">
                	<div class="col-md-3 col-sm-4 col-xs-9 main_menu_logo">
                    	<a href="<?php echo SITE_ROOT; ?>">
                        	<img src="<?php echo SITE_IMAGES; ?>logo.jpg" alt="" title="">
                        </a>
                    </div>
                                    ...
                                    <ul class="menu_dropdown">
                                        ...
                                        ?>
                                        	...
                                        	<li <?php if($countSUBTYPE > intval(0)){ echo 'class="menu_sub_item"'; } ?> >
                                            	<a href="<?php if($countSUBTYPE == intval(0)){ echo $masterURL; } else { echo '#'; }?>"><?php echo $typeNAME; ?></a>
                                                    <?php
                                                        if($countSUBTYPE > intval(0)){
                                                            ?>
                                ...
                                <li class="menu_item">
                                	...
                                	<ul class="menu_dropdown">
                                    	...
                                    	<li>
                                            ...
                                            {
                                            ?>
                                                <a href="<?php echo SITE_ROOT .urlRewrite("login.php").$_SESSION['INCLUDE_QMARK']."ref=members";?>">
                                            <?php
                                            }   
                                            ?>
