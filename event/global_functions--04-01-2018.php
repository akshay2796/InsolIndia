...
function MailObject($TO=array(), $FROM="", $CC=array(), $BCC=array(), $SUBJECT="", $BODY="", $ATTACHMENTS = array(),$REPLYTO="")
{
                        ...
                        $MAIL_BODY .= '<tbody>';
                            ...
                            {     
                                ...
                                if ( count($rsGET) > intval(0) )
                                {
                                    ...
                                    $MAIL_BODY .= '<tr>';
                                        $MAIL_BODY .= '<td bgcolor="#2E3192" style="color: #ffffff; padding: 12px 20px; text-align: center; font-size: 20px; font-weight: bold;">Hi '.$name.'</td>';
                                    $MAIL_BODY .= '</tr>
                                    ...
                                    <tr>
                                        <td valign="top" style="height: 250px; color: #333; text-align: left; font-size: 12px;">
                                            ...
                                            You may make payment of Rs. 5000 by cheque drawn on INSOL India on the following address: 
                                            <strong>INSOL India, 5, Mathura Road, 3rd Floor, Jangpura-A, New Delhi-110014. <br>Contact No. 011 49785744 </strong><br><br>
                                            You may also make the payment by electronic transfer in the Bank Account of INSOL India. The details are as follows:<br><br>
                                            <strong>INSOL INDIA</strong><br>
                                            A/C NO. - 126010200004480<br>
                                            IFSC Code - UTIB0000126<br>
                                            Account Type - Current<br>
                                            Bank - Axis Bank Limited<br>
                                            Branch - Lajpat Nagar<br><br>
                                            ...
                                            <strong>Please note: </strong>Only after payment has been received in our account than your membership will be activated.
                                        </td>
                                    </tr>';
                              ...
                              <tbody>
                                    ...
                                    <tr>
                                        ...
                                        '.$telephone.' '.$residence_telephone.' '.$fax.' '.$mobile.' | E. '.$email.'<br><br>
                                            ...
                                            {
                                                $mMAIL .= '<div style="padding: 15px 0; border-top: 1px solid #ccc;">			  
                                                I am registered Insolvency Professional with Insolvency and Bankruptcy Board of India My registration number is <strong style="color: #ED1C24;">'.$registered_insolvency_professional_number.'</strong>.
                                                </div>';
                                            }
                                            ...
                                            {
                                                $mMAIL .= '<div style="padding: 15px 0; border-top: 1px solid #ccc;">			  
                                                I am a Young Practitioner. I confirm I have less than ten years experience in my profession mentioned in column 1.  My date of enrolment with my professional body is <strong style="color: #ED1C24;">'.$young_practitioner_enrolment.'</strong>.
                                                </div>';
                                            }
                                            ...
                                            {
                                                $mMAIL .= '<div style="padding: 15px 0; border-top: 1px solid #ccc;">			  
                                                I am an SIG Member  : <strong style="color: #ED1C24;">'.$sig_company_name.'</strong>.
                                                </div>';
                                            }
...
function newsletterFormat($ID,$via = "")
{
    global $dCON;
                                        ...
                                        <tr>
                                            <td width='300px' valign='top'>					  
                                                                ...
                                                                <td bgcolor='#ffffff' style='background: #ffffff; padding: 20px;'>
                                                                    <table width='100%' border='0' cellspacing='0' cellpadding='0' style='font-family: arial;'>
                                                                        <tbody>";
                                                                            ...
                                                                            $mMAIL .= "<tr>";
                                                                                //<td width='60px' valign='top' style='line-height: 0px;'><img src='".$display_image_editor."' width='68px' style='width: 68px; display:inline-block; line-height:0px;' alt=''/></td>
                                                                ...
                                                                <td bgcolor='#ffffff' style='background: #ffffff; padding: 20px;'>
                                                                    <table width='100%' border='0' cellspacing='0' cellpadding='0' style='font-family: arial;'>
                                                                        <tbody>";
                                                                            ...
                                                                            $mMAIL .= "<tr>";
                                                                                //<td width='60px' valign='top' style='line-height: 0px;'><img src='".$display_image_president."' width='68px' style='width: 68px;display:inline-block; line-height:0px;' alt=''/></td>
                                                                                //<td width='15px' valign='top' style='line-height: 0px;'><img src='".SITE_IMAGES."15.jpg' style='display:inline-block; line-height:0px;' alt=''/></td>
                                                ...
                                                if(count($rowSP) > 0)
                                                {
                                                    $mMAIL .= "<table width='100%' border='0' cellspacing='0' cellpadding='0' style='border: 1px solid #ccc; font-family: arial;'>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td bgcolor='#ffffff' align='center' style='background: #ffffff; text-align:center; padding: 15px 12px;'>";
                                                                        $s=1;
                                                                        foreach($rowSP as $rsSP)
                                                                        {
                                                                            ...
                                                                            if(intval($chk_file_sponsor) == intval(1))
                                                                            {
                                                                                ...
                                                                                $mMAIL .= "".$sponsor_url."<img src='".$display_image_sponsor."' height='50px' style='height: 50px; line-height:0px; display: inline-block; margin: 8px;' alt='".$company_name."'/>".$sponsor_url_end."";
                                                ...
                                                if(count($rowSIG) > 0)
                                                {
													...
													<table width='100%' border='0' cellspacing='0' cellpadding='0' style='border: 1px solid #ccc; font-family: arial;'>
                                                        <tbody>
                                                            <tr>
                                                    ...
                                                    <tr>
                                                        <td style='text-align: right;'>
															<table width='210' border='0' cellspacing='0' cellpadding='0' align='right'>
															  <tbody>
																<tr>
																  <td nowrap align='center' bgcolor='#000000' style='padding: 6px 10px; background: #000; white-space: nowrap; color: #ffffff; font-size: 11px; text-transform: uppercase;'>Volume ".$volume_name.", Issue ".$newsletter_issue." | ".$newsletter_date."</td>
																</tr>
															  </tbody>
															</table>
                                                                        ...
                                                                        foreach($rowNews as $rsNews)
                                                                        {
                                                                            ...
                                                                            $mMAIL .= "<tr>
                                                                                ...
                                                                                <td width='172' valign='top' style='line-height: 0px;'>
                                                                                    <img src='".$DISPLAY_NEWS_IMG."' width='172px' style='display:inline-block; width: 172px; line-height:0px;' alt='' />
                                                                                </td>
...
function generaluploadFormat($ID,$via = "", $person_name= "")
{
    global $dCON;
                ...
                <td bgcolor='#eaeaea' align='center'>
                    <table width='848' border='0' cellspacing='0' cellpadding='0' align='center' style='font-family: arial; border: 1px solid #EAEAEA;'>
                        <tbody>
                            ...
                            <tr>
                                <td bgcolor='#4abea3' style='background: #4abea3; color: #ffffff; font-size: 18px; padding: 12px 25px; font-weight:bold;'>Dear ".$person_name."</td>
                            </tr>
                            <tr>
