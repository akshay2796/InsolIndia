...
<div style="position: fixed; top: 180px; left: 0; z-index: 9999;"><a href="<?php echo SITE_ROOT . urlRewrite("draft_best_practices.php"); ?>"><img src="images_insol/draft-best-practices.png" alt=""/></a></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    ...
                    <iframe width="100%" height="260" src="https://www.youtube.com/embed/Rv6ZgFzWrik" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="col-sm-6 col-md-6">
            <h2>Our Projects</h2>
    ...
    <div class="clearfix ">
     ...
     <div class="container">
            <h2 style="font-size: 26px;" align="center">TRANSNATIONAL COMMERCIAL LAW INSOLVENCY</h2>
            <div class="row series_carosel">
                <div class="col-sm-6 col-md-6">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/ToE5NfvGEUs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center">Virtual International Symposium on Insolvency and Bankruptcy Code 2016 - Date 7th January, 2021</h4>
                </div>
                <div class="col-sm-6 col-md-6">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/vdgEWXFAYyE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center">Virtual International Symposium on Insolvency and Bankruptcy Code 2016 - Date 7th January, 2021</h4>
                </div>
                <div class="col-sm-6 col-md-6">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/vMZrHx9zLjs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center">Virtual International Symposium on Insolvency and Bankruptcy Code 2016 - Date 7th January, 2021</h4>
                </div>
                <div class="col-sm-6 col-md-6">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/mYnu8Z72Bok" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center">Virtual International Symposium on Insolvency and Bankruptcy Code 2016 - Date 7th January, 2021</h4>
                </div>
                <div class="col-sm-6 col-md-6">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/zKMnt65TDBY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center">Virtual International Symposium on Insolvency and Bankruptcy Code 2016 - Date 7th January, 2021</h4>
                </div>
                <div class="col-sm-6 col-md-6">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/r3gFOUgN_pY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center">Virtual International Symposium on Insolvency and Bankruptcy Code 2016 - Date 7th January, 2021</h4>
                </div>
                <div class="col-sm-6 col-md-6">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/nZSFOtKhUWY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center">Virtual International Symposium on Insolvency and Bankruptcy Code 2016 - Date 6th January, 2021</h4>
                </div>
                <div class="col-sm-6 col-md-6">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/xtfzJWBFCmI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center">Virtual International Symposium on Insolvency and Bankruptcy Code 2016 - Date 6th January, 2021</h4>
                </div>
                <div class="col-sm-6 col-md-6">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/gkV3lHTS-aI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center">Virtual International Symposium on Insolvency and Bankruptcy Code 2016 - Date 6th January, 2021</h4>
                </div>
                <div class="col-sm-6 col-md-6">
                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/HlAAZGOp1XE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center">Virtual International Symposium on Insolvency and Bankruptcy Code 2016 - Date 6th January, 2021</h4>
                </div>
    ...
    <div class="clearfix ">
     ...
     <div class="container">
            <h2 style="font-size: 26px;" align="center"> 4th International Insolvency Bankruptcy Moot Competition  </h2>
            <div class="row series_carosel">
                <div class="col-sm-6 col-md-6">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/KrFietFVg-8" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center"> INSOL India - 4th International Insolvency Bankruptcy Moot Competition Valedictory Ceremony</h4>
                </div>
                <div class="col-sm-6 col-md-6">
                  <iframe width="560" height="315" src="https://www.youtube.com/embed/KmAcuHOgVzQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <h4 align="center"> INSOL India - 4th International Insolvency Bankruptcy Moot Competition Finals</h4>
                </div>
