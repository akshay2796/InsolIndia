...
<!--===INDEX PAGE===-->
    <!--===BANNER===-->
    <!--div class="clearfix main_slider">
        <div class="single-item-rtl">
            <div>
                <img src="images_insol/banner.jpg">
                <div class="img_caption">
                    <h2>News</h2>
                    <h5>Sunday 11th March, 2017</h5>
                    <p>
                    	<a href="news1.php">INSOL India conducts research, holds seminars, conferences, workshops and discussions for development</a>
                    </p>
                </div>
            </div>
    ...
    <div class="clearfix home_banner">
    	...
    	<img class="homebanner" src="<?php echo SITE_IMAGES; ?>banner.jpg">
        ...
        <div class="container">
            <div class="col-md-8 col-sm-12 col-xs-12 index_about_left">
                <div class="index_about_left_img">
                    <img src="<?php echo SITE_IMAGES; ?>about_insol.jpg" alt="About INSOL">
                </div>
                            ...
                            ?>
                                <div> 
                                    ...
                                    <div class="about_slider_cap">
                                        ...
                                        ?>
                                                <h4>
                                                    <a href="<?php echo SITE_ROOT . $event_link; ?>">Register To Attend</a>
                                                </h4>
