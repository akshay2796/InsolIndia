                    ...
                    if (parseInt(spl_txt[1]) == parseInt(1)) {
                        setTimeout(function() {
                            ...
                            window.location.href =
                                "<?php echo SITE_ROOT . 'thankyou.php?ty=member' ?>";
                        }, 2000);
                    } else {
        ...
        <div class="col-md-10 col-sm-9 inner_page_right">
            ...
            <div class="row">
                <div class="col-md-10" style="padding-right: 0px;">
                    <h3 class="subsubHead">If you would like to Become a Member of INSOL India, Please send us a request
                        by filling the following details.</h3>
                    <br>
                    <div class="row">
                        <form action="" name="frmReg" id="frmReg">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="first_name" id="first_name"
                                        placeholder="" maxlength="100" style="text-transform:capitalize">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="middle_name" id="middle_name"
                                        placeholder="" maxlength="50" style="text-transform:capitalize">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="1" name="correspondence_address_2"
                                        id="correspondence_address_2"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="correspondence_state"
                                        id="correspondence_state" placeholder="" maxlength="50">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="pin" id="pin" placeholder=""
                                        maxlength="10" onkeyup="integerOnly(this)">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                            ...
                            <div class="hrline"></div>
                            <div class="col-md-12">
                                <h4>Permanent Address <input type="checkbox" value="1" name="address_check"
                                        id="address_check" /> <span style="color: #2B3481; font-size: 15px;">(Check if
                                        different from correspondence address)</span></h4>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="1" name="permanent_address_2"
                                            id="permanent_address_2"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="permanent_city"
                                            id="permanent_city" placeholder="" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="permanent_state"
                                            id="permanent_state" placeholder="" maxlength="50">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="permanent_pin" id="permanent_pin"
                                            placeholder="" maxlength="10" onkeyup="integerOnly(this)">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="permanent_country"
                                            id="permanent_country" placeholder="" maxlength="50">
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="mobile" id="mobile" placeholder=""
                                        maxlength="12" onkeyup="integerOnly(this)">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label>Email <span>*</span><span class="" style="color: red;"
                                            id="errorNL"></span></label>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="residence_telephone"
                                        id="residence_telephone" placeholder="" maxlength="12"
                                        onkeyup="integerOnly(this)">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <label>
                                                <input type="checkbox" value="Chartered Accountant" name="i_am[]"
                                                    id="i_am[]" class='i_am' /> Chartered Accountant
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label>
                                                <input type="checkbox" value="Cost Accountant" name="i_am[]" id="i_am[]"
                                                    class='i_am' /> Cost Accountant
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label>
                                                <input type="checkbox" value="Advocate" name="i_am[]" id="i_am[]"
                                                    class='i_am' /> Advocate
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label>
                                                <input type="checkbox" value="Company Secretary" name="i_am[]"
                                                    id="i_am[]" class='i_am' /> Company Secretary
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label>
                                                <input type="checkbox" value="Judge" name="i_am[]" id="i_am[]"
                                                    class='i_am' /> Judge
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label>
                                                <input type="checkbox" value="Member of NCLT" name="i_am[]" id="i_am[]"
                                                    class='i_am' /> Member of NCLT
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label>
                                                <input type="checkbox" value="Academic" name="i_am[]" id="i_am[]"
                                                    class='i_am' /> Academic
                                            </label>
                                        </div>
                                        <div class="col-md-4">
                                            <label>
                                                <input type="checkbox" value="Other" name="i_am[]" id="i_am[]"
                                                    class='i_am' /> Other
                                            </label>
                                        </div>
                                        <div class="col-md-4" style="display: none" id="otherIm">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="other_i_am"
                                                    id="other_i_am" placeholder="Please Specify">
                                                <input type="hidden" class="form-control" name="i_am_chkvalue"
                                                    id="i_am_chkvalue" style="display: none;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>
                                        <h4 class="bluetxt">
                                            <!--input type="checkbox" value="1" name="insolvency_professional" id="insolvency_professional"/ -->
                                    ...
                                    <div class="row d-flex-column">
                                        ...
                                        <div class="col-md-6">
                                            <label>My registration number is</label><input type="text"
                                                class="form-control" name="insolvency_professional_number"
                                                id="insolvency_professional_number" placeholder="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>
                                        <h4 class="bluetxt"><input type="checkbox" value="1"
                                                name="registered_insolvency_professional"
                                                id="registered_insolvency_professional"> I am registered Insolvency
                                            Professional with Insolvency and Bankruptcy Board of India.</h4>
                                    </label>
                                    <div class="row">
                                        <div class="clr"></div>
                                        <div class="col-md-12">
                                            <label>My registration number is</label><input type="text"
                                                class="form-control" name="registered_insolvency_professional_number"
                                                id="registered_insolvency_professional_number" placeholder="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <label>
                                        <h4 class="bluetxt"><input type="checkbox" value="1" name="young_practitioner"
                                                id="young_practitioner"> I am a Young Practitioner. I confirm I have
                                            less than ten years experience in my profession mentioned above. </h4>
                                    </label>
                                    <div class="row">
                                        <div class="clr"></div>
                                        <div class="col-md-12">
                                            <label>My date of enrolment with my professional body is</label><input
                                                type="text" class="form-control" name="young_practitioner_enrolment"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>
                                        <h4 class="bluetxt"><input type="checkbox" value="1" name="sig_member"
                                                id="sig_member"> I am an SIG 24 Member. </h4>
                                    </label>
                                    <div class="row">
                                        <div class="clr"></div>
...
foreach ($rsGET as $sVAL) {
        ...
        ?>
                                                <option value="<?php echo $company_id; ?>"><?php echo $company_name; ?>
                                                </option>
...
?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="clr"></div>
                                        <div class="col-md-12">
                                            <textarea class="form-control" rows="2" name="interested" id="interested"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><input type="checkbox" value="1" name="terms" id="terms" /> I confirm that
                                        the information provided in this form is true and correct.</label>
                                ...
                                <div class="form-inline">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="" maxlength="2" name="numsum" id="numsum"
                                                class="form-control" onblur="integerOnly(this)" autocomplete="OFF"
                                                style="width:75px;" />

                                            &nbsp;<span class="" style="color: red;" id="errorCAP"></span>

                                            <input type="hidden" name="capRES" id="capRES"
                                                value="<?php echo $capRES; ?>" readonly='' style="display:none" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div style="color:#B71D21">Please fill the form as per requirements and irrelevant
                                    sections may be filled as not applicable or N/A. </div>
                            </div>
                            <div class="clr height15"></div>
                            <div class="col-md-6">
                                <div class="form-group">
