...
<div class="container">
    <div class="clearfix inner_page">
      ...
      <textarea name="edit_box" id="edit_box" style="width:100%;height:100px;text-align:left;" autofocus="textarea" placeholder="" maxlength=250 required /></textarea>
		...
		<div class="col-sm-12" style="text-align:left;margin-top:40px;">
      <textarea name="p_detail" id="p_detail" placeholder=" This is textbox" style="width:100%;height:100px;text-align:left;"  required / >        
      </textarea>
    </div>
...
<div class="col-sm-12" style="margin-top:30px;">
        ...
        <div class="col-sm-2" style="border:1px solid;margin-left:10px;width:150px;">@18,880/-</div>-->
	       ...
	       <p style="margin-left:10px;margin-top:150px;">should you have any queries, please contact us at <a>contact@insolindia.com</a>, or call 49785744.</p>
	         ...
	         <p style="margin-left:10px;margin-top:100px;">DELEGATE NAME, FIRM AND COUNTRY WILL BE LISTED ON THE DELEGATE LIST. PHOTOS AND VIDEO MAY BE TAKEN DURING THE SEMINAR FOR PUBLICATION. PLEASE BRING YOUR CONFIRMATION AND PHOTGRAPHIC IDENTIFICATIOBN WITH YOU IN ORDER TO COLLECT YOUR BADGE AND SEMINAR PAPERS </P>
	     <div class="hrline"></div>
       <div class="col-sm-12">
           <div class="col-sm-12">
