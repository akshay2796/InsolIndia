                                ...
                                if ( count($rsGET) > intval(0) )
                                {
                                    ...
                                    <tr>
                                        <td valign="top" style="height: 250px; color: #333; text-align: left; font-size: 12px;">
                                            ...
                                            You can make the payment of Rs 5900 (5000+18% GST) through either of the following mechanism:<br><br>
...
function newsletterFormat($ID,$via = "", $person_name)
{
    ...
    $president_text = limit_words($president_text, 75); 
                        ...
                        <table width='848' border='0' cellspacing='0' cellpadding='0' align='center' style='font-family: arial; border: 1px solid #EAEAEA;'>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <h1 bgcolor='#fff' style='font-weight: bold; font-size: 20px; margin:0px; padding:0px;'>".$greetings;$mMAIL .= $person_name . $seperator . "<br>Welcome to INSOL India Newsletter Volume ".$volume_name.", Issue ".$newsletter_issue." | ".$newsletter_date."</h1></td>
                                </tr>
                    			<tr>
