    ...
    <div class="clearfix inner_page members">
       <!--h2>MEMBERS LIST OF INSOL INDIA</h2-->
              ...
              <?php
               ...
               {
               ?>
                    <input type="reset" value="Clear Search" class="btn btn-primary" style="background-color: #B71D21;" onClick="document.location.href='<?php echo SITE_ROOT .urlRewrite("members.php")?>';" >
              <?php } ?>
           ...
           ?>
                    <tbody>
                       <tr style="border-top: 0;">
                        ...
                        ?>
                            <tr>
								<td width="40px" class="mem_td"><span class="img-circle" style="width: 30px; height:30px; background: #B71D21; text-align: center; display: inline-block; line-height: 30px; color: #ffffff;"><?php echo $count; ?></span></td>
