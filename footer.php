            ...
            <div class="container">
                <div class="col-md-8 col-sm-8 footer_left">
                    <div class="footer_left_icon">
                        <img src="<?php echo SITE_ROOT ?>images_insol/footer_icon.png">
                    </div>
                    <div class="footer_left_text">
                        <h3>5, Mathura Road, 3rd Floor, Jangpura-A, New Delhi-110014. <br> Contact No. 011 49785744 |
                            Email: <a href="mailto:contact@insolindia.com">contact@insolindia.com</a></h3>
                        <p>&copy; 2017 INSOL India, All rights reserved. Site Designed By <a
                                href="https://www.infomediawebsolutions.com/" target="_blank">Infomedia Web
                                Solutions</a>.</p>
                    </div>
                </div>
