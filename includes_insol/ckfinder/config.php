...
function CheckAuthentication()
{
    ...
    if(isset($_SESSION['USERID_DPG'])){ // for cms
	   return isset($_SESSION['USERID_DPG']) && $_SESSION['USERID_DPG'];
    }
    elseif($_SESSION['UID_INSOL']) // for front end loggined user
    {
        return isset($_SESSION['UID_INSOL']) && $_SESSION['UID_INSOL'];
    }
