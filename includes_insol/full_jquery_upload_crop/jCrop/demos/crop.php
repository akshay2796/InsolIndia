...
<h1>Server-based Cropping Behavior</h1>
		...
		<img src="demo_files/banner5.jpg" id="cropbox" />

		<!-- This is the form that our event handler fills -->
		<form action="crop.php" method="post" onsubmit="return checkCoords();">
			<input type="thidden" id="x" name="x" />
			<input type="thidden" id="y" name="y" />
			<input type="thidden" id="w" name="w" />
			<input type="thidden" id="h" name="h" />
