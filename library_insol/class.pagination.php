        ...
        if($noOfPages>1) 
        {
            if(isset($pageNo))
            {
               ...
               // $page.="<a class='paging' href='javascript:pagination($prev_loop);'>Prev</a>";
                $page.="<span class='pagingTxt'><a href='javascript:void(0);' id = '$one' class='paging'>First</a></span>&nbsp;";
                $page.="<span class='pagingTxt'><a href='javascript:void(0);' id = '$prev_loop' class='paging'>Prev 10</a></span>";
                }
            }
            $x=0;
            $j=1;
            for($i=$loop; $i<=$noOfPages; $i++) 
            {
                ...
                if($i==$pageNo)
                {
                    $page.="&nbsp;<span class='paging_active' >".$i."</span>&nbsp;";
                }
                ...
                {
                    $page.="&nbsp;<span class=''><a class='paging' href='javascript: void(0);' id = '".$i;
                    $page.="'>".$i."</a></span>&nbsp;";
            ...
            if($pageNo!=$last && $noOfPages>10)
            {
                ...
                if($ll!=$loop)
                {
                    ...
                    $page.="<span class='pagingTxt'><a class='paging' href='javascript:void(0);' id = '$pp'>Next 10</a></span>&nbsp;";
                    $page.="<span class='pagingTxt'><a class='paging' href='javascript:void(0);' id = '$ll'>Last</a></span>";
                }                
            }
