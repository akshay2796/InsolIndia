...
{ 
    ...
    if( intval($CHK) == intval(0) )
    {
        ...
        if($dbRES == 1)
        {
            ...
            //  $MAIL_FORMAT = '<table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td><table width="600" border="0" cellspacing="0" cellpadding="20" style="border:12px solid #efefef;font-family:Helvetica,Arial,sans-serif" align="center"><tbody><tr><td style="border-bottom:4px solid #ed1c24"><img src="https://ci6.googleusercontent.com/proxy/7wXMzotkQIRiAGU7g7_3tw8M7nKmUMp7fwvz7vMaJMgptjGha9f8rf0Ny-kKWkHjjXcxr5qb33mYIKl4i93HdaXCEt63bDM=s0-d-e1-ft#http://www.insolindia.com/images_insol/mail-logo.png" alt="" class="CToWUd"></td></tr><tr><td bgcolor="#2E3192" style="color:#ffffff;padding:12px 20px;text-align:center;font-size:20px;font-weight:bold">Dear '.$name.'</td></tr>
                        ...
                        <tbody>
                            ...
                            <tr style="height: 187.5pt">
                                <td valign="top" style="border: none; padding: 15.0pt 15.0pt 15.0pt 15.0pt; height: 187.5pt">
                                    <h1 style="margin-bottom: 3.75pt"><span style="text-trsansform:uppercase;font-size: 12.0pt; font-family: Helvetica; color: #2E3192">'.$name.'</span>
                                    </h1>
