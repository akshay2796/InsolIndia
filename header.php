						...
						<div class="col-md-6 col-sm-6 col-xs-12">   
							...
							<nav class="sub_menu">
								<ul>
                                    ...
                                    <ul >
                            	<li class="menu_item">
                                	<a href="<?php echo SITE_ROOT . urlRewrite("events.php"); ?>" style="color:#fff;padding: 10px 0px;font-weight: normal;font-size: 12px;">Events & Webinar</a>
                                    <ul class="menu_dropdown">
                                        <li>
                                        	<a href="<?php echo SITE_ROOT . urlRewrite("events.php"); ?>">All Events</a>
                                        </li>
                                    	<li>
                                        	<a href="<?php echo SITE_ROOT ?>events?event=upcoming" >Upcoming Events</a>
                                        </li>
										<li>
											<a href="<?php echo SITE_ROOT; ?>events?event=past">Past Events</a>
										</li>
                                    </ul>
                                </li>
                                </ul>
