...
$objPHPExcel->getActiveSheet()->getStyle('AA1:AG1')->applyFromArray($styleArray); 
$objPHPExcel->getActiveSheet()->getStyle('AA2:AG2')->applyFromArray($styleArray); 
...
$objPHPExcel->setActiveSheetIndex(0)->mergeCells('AA1:AG1');
$objPHPExcel->getActiveSheet()
    ->getCell('AA1')
    ->setValue('PROFESSIONAL  DETAILS');


$objPHPExcel->getActiveSheet()->setAutoFilter('A2:AG2');
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('AB'.$ROW,"INSOLVENCY PROFESSIONAL AGENCY NAME")
            ...
            ->setCellValue('AF'.$ROW,"SIG COMPANY NAME ")
            ->setCellValue('AG'.$ROW,"YOUNG PRACTITIONER ");           
...
{  
    ...
    */
    ...
    ->setCellValue('AF' . $ROW, $sig_company_name)
