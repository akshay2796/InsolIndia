...
<h1>General Newsletter<div class="addProductBox"><a href="<?php echo PAGE_LIST;?>" class="backBtn">Go To List</a></div></h1>
...
<div class="addWrapper master">
    ...
    <div class="fullWidth">                    	
            <div class="width3">
                ...
                <input type="text" class="txtBox" value="<?php echo $reference;?>" name="reference" id="reference" AUTOCOMPLETE = "OFF" maxlength="200"/>
            </div>
            
                <div class="width3">
                <label class="mainLabel">Date <span>*</span> </label>
                    <input type="text" class="titleTxt txtBox" name="upload_date" id="upload_date" value="<?php echo $upload_date; ?>" maxlength="12" placeholder="Date" style="width: 90px;" autocomplete="OFF" />&nbsp;&nbsp;
