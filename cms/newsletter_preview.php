...
$(document).ready(function() {
    ...
    $.validator.addMethod('ck_testemail', function(data) {
        ...
        if ($('#send_to_insol_member').prop("checked") == false && $('#test_group_email').prop(
                "checked") == false && $.trim($("#test_email").val()) == "" && checked_governance
            .length == parseInt(0)) {
            return false;
        } else {
            return true;
                        ...
                        setTimeout(function() {
                            ...
                            if (parseInt(spl_txt[1]) == parseInt(1)) {
                                window.location.href =
                                    "<?php echo "send-newsletter.php"; ?>?nid=<?php echo $ID;?>&testmail=" +
                                    spl_txt[3] + "&mct=" + spl_txt[4];
...
<form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
    ...
    <h1>
        Newsletter Preview <div class="addProductBox"><a href="<?php echo PAGE_LIST;?>" class="backBtn">Go to List</a>
        </div>
    </h1>
        ...
        <div class="containerPad">
            <div class="fullWidth noGap">
                <div class="width2">
                    ...
                    <input type="text" class="txtBox" name="newsletter_subject" id="newsletter_subject"
                        value="<?php echo $newsletter_subject; ?>" maxlength="100" autocomplete="OFF" />
                </div>
                <div class="width2">
                    ...
                    <input type="text" class="txtBox" name="test_email" id="test_email"
                        value="<?php echo $test_email; ?>" maxlength="400" autocomplete="OFF" />
                </div>
            </div>
            <div class="fullWidth noGap">
                <div class="fullWidth noGap">
                    ...
                    <div class="width24 memberH" style="min-height:auto !important; margin-bottom:0px;">
                        <label class="checkBoxWidth" style="width:100%;"><input type="checkbox"
                                name="send_to_insol_member" id="send_to_insol_member" value="1"
                ...
                $gGET->closeCursor();
                 if(intval(count($gVAL)) > intval(0)){
                    foreach($gVAL AS $rVAL){
                        ...
                        ?>
                    <div class="width24 memberH" id="governance_id"
                        style="min-height:auto !important; margin-bottom:0px;">
                        <!--label class="mainLabel">Send To </label-->
                        <label class="checkBoxWidth" style="width:100%;"><input type="checkbox"
                                name="send_to_governance[]" id="send_to_governance_<?php echo $type_id; ?>"
