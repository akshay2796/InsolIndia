...
$(document).ready(function(){
    ...
    {
        if ( $('#sig_member').prop("checked")==true  && $.trim($("#membership_starts_date").val()) == "" && $.trim($("#register_status").val()) =='Approved')
        {
            return false;                    
        }
        else
...
$(function() {
    ...
    $('#membership_expired_date').datepick({
        dateFormat: 'dd-mm-yyyy',
    	yearRange: '<?php echo date("Y", strtotime('-1 year')); ?>:<?php echo date("Y", strtotime('+5 year')); ?>'
    });  
    $('#renewal_start_date').datepick({
        dateFormat: 'dd-mm-yyyy',
    	yearRange: '<?php echo date("Y", strtotime('-1 year')); ?>:<?php echo date("Y", strtotime('+5 year')); ?>'
    }); 
    $('#renewal_end_date').datepick({
        dateFormat: 'dd-mm-yyyy',
    	yearRange: '<?php echo date("Y", strtotime('-1 year')); ?>:<?php echo date("Y", strtotime('+5 year')); ?>'
    }); 
...
<input type="hidden" name="membership_start_date_old" value="<?php echo $membership_start_date_old; ?>" id="membership_start_date_old" />        
    ...
    <div class="containerPad" id="editOrderSpecial">
		...
		<div class="col-sm-4">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="gst_no" id="gst_no" placeholder="" value="<?php echo $gst_no; ?>" maxlength="100" >
			</div>
		</div>
		<!--div class="col-sm-4">
			<div class="form-group">
...
// $title =  $show['title'];
        ...
        <div class="fullWidth">   
            ...
            ?>
                <div class="width4">
                	<label class="mainLabel">Membership Expiry Date <span>*</span></label> 
                    <input type="text" class="titleTxt txtBox" name="membership_expired_date" id="membership_expired_date" value="<?php echo $membership_expired_date; ?>" maxlength="12" placeholder=""  autocomplete="OFF" />&nbsp;&nbsp;
                </div>
            ...
            <div class="width4">
                    ...
                    <input type="text" class="titleTxt txtBox" name="renewal_start_date" id="renewal_start_date" value="<?php echo $membership_expired_date; ?>" maxlength="12" placeholder=""  autocomplete="OFF" />&nbsp;&nbsp;
                </div>
                <div class="width4">
                	<label class="mainLabel">Renewal End Date <span>*</span></label> 
                    <input type="text" class="titleTxt txtBox" name="renewal_end_date" id="renewal_end_date" value="<?php  echo $show['renewal_end_date']; ?>" maxlength="12" placeholder=""  autocomplete="OFF" />&nbsp;&nbsp;
                </div>
                <div class="width2">
                    	<label class="mainLabel">Renewal Payment Detail</label>
                        <input type="text" name="renewal_payment_text" value="<?php echo $show['renewal_payment_detail']; ?>" id="payment_text" autocomplete="OFF" class="txtBox" />
                    </div>
            <?php
            // }
            // else
...
while($show3 = mysqli_fetch_array($result)){ ?>
        ...
        <input type="text" name="payment_text" value="<?php echo $show3['add_date']; ?>" id="payment_text" autocomplete="OFF" class="txtBox" readonly="" />
        <a href="renew_export.php?member_id=<?php echo $u_id; ?>&add_date=<?php echo $show3['add_date']; ?>"><img src="../includes_insol/images/cms-icon/excel_icon.png" border="0" title="Export to Excel" alt="Export to Excel" align="absmiddle"></a>
        <br><br>
