...
define("PAGE_MAIN","governace_type.php");	
...
<div class="addWrapper master">
    ...
    <div class="containerPad expendableBox">
        ...
        <div class="fullWidth div_content validateMsg">
            <textarea name="type_description" id="type_description" style="width:90%; height:230px; float:left;" ></textarea>
            <script>
