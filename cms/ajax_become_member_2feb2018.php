                                    ...
                                    <?php if( intval($dA) > intval(0)) { ?>
                                        ...
                                        <td align="center" style="padding-right:10px;">
                                            <a href="javascript:void(0);" id="getExcelLatest" class="" style="color:#D9414D;font-weight: bold;">
                                               <img src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH; ?>excel_icon.png" border="0" title="Export to Excel" alt="Export to Excel" align="absmiddle" /> Export to Excel (latest)
                                            </a>
                                        </td>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" border='0'>
                        ...
                        foreach($row as $rs)
                        {
                            ...
                            <tr class="expiredCoupons trhover" >
                                ...
                                <td>
                                	<?php echo ucwords(strtolower($first_name.' '.$last_name)); ?> 
                                </td> 
                                <td>
                                	<?php echo $email; ?> 
                                    <?php
...
function registerSave()
{
    ...
    if(strtolower($register_status)=='approved')
    {
        ...
        $reg_number_text = 'INSOL/T/'.$reg_number;
    ...
    if(strtolower($register_status)=='approved')
    {
        $sDEF->bindParam(":reg_number_text_temp", $reg_number_text); 
        $sDEF->bindParam(":reg_number_temp", $reg_number); 
    }
