...
?>
        ...
        filters: [{
            title: "Image files",
            extensions: "jpg,jpeg,pjpeg,gif,png"
        }]
    });
...
<form id="frmReg" name="frmReg" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="addWrapper">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="title" id="title">
                        ...
                        <option value="Hon'ble Mr. Justice"
                            <?php if ($title == "Hon'ble Mr. Justice") {echo "selected";}?>>Hon'ble Mr. Justice</option>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="firm_name" id="firm_name" placeholder=""
                        maxlength="13" value="<?php echo $firm_name; ?>">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label>Gst No <span>*</span>
                    </label>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pin" id="pin" placeholder=""
                        onkeyup="integerOnly(this)" maxlength="10" value="<?php echo $pin; ?>">
                </div>
            </div>
		...
		<div class="col-sm-4">
            ...
            <div class="hrline"></div>
            <div class="col-md-12">
                <h4>Permanent Address <input type="checkbox" value="1" name="address_check" id="address_check" /> <span
                        style="color: #245999; font-size: 15px;">(Check if different address)</span></h4>
            </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="permanent_state" id="permanent_state"
                            placeholder="" maxlength="50" value="<?php echo $permanent_state; ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label>
                                <input type="checkbox" value="Academic" name="i_am[]" id="i_am[]" class='i_am'
...
?>
                ...
                <div class="col-md-3" id="showMEMDATE"
                    <?php if ($sig_member == intval(0)) {echo "style='display:none'";}?>>
                    ...
                    <div class="form-group">
                        <input type="text" class="titleTxt txtBox" name="membership_starts_date"
                            id="membership_starts_date" value="<?php echo $membership_start_date; ?>" maxlength="12"
                ...
                <div id="paySTATUS" <?php if ($sig_member == intval(1)) {echo "style='display:none;'";}?>>
                        ...
                        <div class="form-group">
                            ...
                            <select name="payment_status" id="payment_status" class="form-control">
                                <option value="PENDING"
                                    <?php if (trim($payment_status) == "PENDING") {echo "Selected";}?>>Pending</option>
                                <option value="SUCCESSFUL"
                                    <?php if (trim($payment_status) == "SUCCESSFUL") {echo "Selected";}?>>Successful
                                </option>
                                <option value="CANCELLED"
                                    <?php if (trim($payment_status) == "CANCELLED") {echo "Selected";}?>>Cancelled
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="payment_text" value="<?php echo $payment_text; ?>"
                                id="payment_text" autocomplete="OFF" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group" id="uploadImgPos">
                            ...
                            <label class="mainLabel"> Upload Payment Receipt <span style="color: #0080C0;">(Allowed
                                    Formats : <img src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH ?>jpg.png" border="0"
                                        alt="jpg | jpeg" title="jpg | jpeg">&nbsp<img
                                        src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH ?>pngIcon.png" border="0"
                                        alt="png" title="png">&nbsp<img
                                        src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH ?>gif.png" border="0" alt="gif"
                                        title="gif">)</span> </label>
