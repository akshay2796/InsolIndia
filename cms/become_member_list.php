        ...
        <form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
            <div class="fullWidth noGap">
				...
				<div class="width3">
                    ...
                    <div class="txt2Box">
                        <input type="text" class="txtBox hw" id="search_from_renewal" name="search_from_renewal" value=""  placeholder="From" />
                        &nbsp;/&nbsp;<input type="text" class="txtBox hw" name="search_to_renewal" id="search_to_renewal" value=""  placeholder="To"/>
                    </div>
                </div>  
