...
?>
    ...
    uploader_main.bind('FileUploaded', function(up, file) {
        ...
        image_list_html = image_list_html +
            '<td><a href="javascript:void(0);" onclick="$(this).removeImage({uFID: \'' + file.id +
...
<h1>Social Media <div class="addProductBox"><a href="<?php echo PAGE_LIST; ?>" class="backBtn">Go To List</a></div>
</h1>
<form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
    <input type="hidden" name="id" id="id" value="<?php echo $id; ?>" />
    <input type="hidden" name="con" id="con" value="<?php echo $con; ?>" />
    <input type="hidden" name="status" id="status" value="<?php echo $status; ?>" />
    <input type="hidden" name="checkImgUploadingProgress" id="checkImgUploadingProgress" value="0" readonly=""
        style="display: none;" />
        ...
        <div class="containerPad expendableBox1">
            <div class="fullWidth noGap">
                <div class="width3">
                    ...
                    <input type="text" class="txtBox" value="<?php echo $news_title; ?>" name="socialmedia_name"
                        id="socialmedia_name" AUTOCOMPLETE="OFF" maxlength="500" />
                </div>
            </div>
            <div class="fullWidth noGap">
                <div class="width3">
                    ...
                    <div class="exlink">
                        <input type="text" class="txtBox" value="" name="socialmedia_link" id="socialmedia_link"
    ...
    if ($display_image != "") {
        ?>
                <div class="removeImageTR uploadImgContainer" id="listItem_<?php echo $image_id; ?>">
                    <div class="uploadImgBox"><img
                            src="<?php echo CMS_INCLUDES_IMAGES_RELATIVE_PATH; ?>blackUploadArea.png" class="fullImg" />
                        ...
                        <table>
                            <tr>
                                <td><a href="javascript:void(0);"
                                        onclick="$(this).removeImage({imageId:<?php echo $news_id; ?>,foldername:'<?php echo $FOLDER_NAME; ?>'});"
                                        class="removeImage"><img
                                            src="<?php echo CMS_INCLUDES_IMAGES_RELATIVE_PATH; ?>cms-icon/trash.png"
                                            title="Delete Thumbnail" border="0" /></a><img
                                        src="<?php echo CMS_INCLUDES_IMAGES_RELATIVE_PATH; ?>loader-small.gif"
                                        class="removeImageLoader" style="display:none;" /> </td>
                            </tr>
                        </table>
                    </div>
                </div>
...
?>
                ...
                <div id="pickfiles_main" class="uploadImgContainer"
                    <?php if ($image_name != "" && $display_image != "") {echo "style='display:none'";}?>>
