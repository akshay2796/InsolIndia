                                        ...
                                        <tr class="expiredCoupons trhover">
                                            ...
                                            <td align="center" width="5%">
                                                <input type="checkbox" class="cb-element" name="chk[]"
                                                    value="<?php echo $projects_id; ?>" />
                                            </td>

                                            <td align="center" width="10%">
                                                <div id="INPROCESS_STATUS_1_<?php echo $projects_id; ?>"
                                                    style="display: none;"></div>
                                                <div id="INPROCESS_STATUS_2_<?php echo $projects_id; ?>">
                                                    <a href="javascript:void(0);" value="<?php echo $projects_id; ?>"
...
if ($DISPLAY_IMG != '') {
            ...
            ?>
                                            ...
                                            <td align="left" width="15%">
                                                <div id="INPROCESS_DELETE_1_<?php echo $projects_id; ?>"
                                                    style="display: none;"></div>

                                                <div id="INPROCESS_DELETE_2_<?php echo $projects_id; ?>">
                                                    <a href="<?php echo PAGE_MAIN; ?>?ID=<?php echo $projects_id; ?>"
