...
if( !is_dir(CMS_UPLOAD_FOLDER_RELATIVE_PATH . FLD_YOUNG_MEMBER_COMMITTEE))
{
    $mask=umask(0);
    mkdir(CMS_UPLOAD_FOLDER_RELATIVE_PATH .  FLD_YOUNG_MEMBER_COMMITTEE, 0777); 
    umask($mask);      
}
...
{   
    ...
    $stmt = $dCON->prepare(" SELECT * FROM " . YOUNG_MEMBER_COMMITTEE_TBL . " WHERE member_id = ? ");
    ...
    $member_email = htmlentities(stripslashes($row_stmt[0]['member_email']));
...
<h1>Young Members Committee <div class="addProductBox"><a href="<?php echo PAGE_LIST;?>" class="backBtn">Go To List</a></div></h1>
    ...
    <div class="containerPad expendableBox1">
        <div class="fullWidth">                    	
            ...
            <div class="width4">
                ...
                <input type="text" class="txtBox" value="<?php echo $member_post;?>" name="member_post" id="member_post" AUTOCOMPLETE = "OFF" maxlength="200"/>
            </div>
            <div class="width2">
        ...
        <div class="fullWidth">
            <div class="width4">
                ...
                <input type="text" class="txtBox" value="<?php echo $member_email;?>" name="member_email" id="member_email" AUTOCOMPLETE = "OFF" maxlength="150"/>
            </div>
        </div>
