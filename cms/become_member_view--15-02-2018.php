...
$full_address = $full_address .", ".$city. ", ".$correspondence_state;
...
$permanent_full_address = $permanent_full_address .", ".$permanent_city.", ".$permanent_state;
                ...
                <table width="600" border="0" cellspacing="0" cellpadding="20" style="border: 12px solid #efefef; font-family: Helvetica, Arial, sans-serif" align="center">
                  <tbody>
                        ...
                        <tr>
                            ...
                            '.$telephone.' '.$mobile.' '.$residence_telephone.' '.$fax.' | E. '.$email.'<br><br>
