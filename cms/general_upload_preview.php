    ...
    <div class="containerPad">
        <div class="fullWidth noGap">
            ...
            <div class="width2">
                ...
                <input type="text" class="txtBox" name="test_email" id="test_email" value="<?php echo $test_email; ?>"  autocomplete="OFF" />
            </div>  
        </div>    
        <div class="fullWidth noGap"> 
        <label class="mainLabel">Send To (Check if yes) </label>
            <div class="width24 memberH" style="min-height:auto !important; margin-bottom:0px;">
              ...
              $SQL_G  = "";
                ...
                <div class="width24 memberH" style="min-height:auto !important; margin-bottom:0px;">
                    <label class="checkBoxWidth" style="width:100%;"><input type="checkbox" name="send_to_all_insol" id="send_to_all_insol" value="1" />Send to all insol member</label> 
                </div> 
        ...
        <div class="fullWidth noGap">
            ...
            <div class="width2">
                ...
                <input type="text" class="txtBox" name="eventSDate" id="event_start_date" value=""  autocomplete="OFF" />
            </div> 
            <div class="width2">
            ...
            <div class="width2">
                ...
                <input type="text" class="txtBox" name="eventEDate" id="event_end_date" value=""  autocomplete="OFF" />
            </div> 
            <div class="width2">
