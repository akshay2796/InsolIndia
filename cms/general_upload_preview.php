...
<script type="text/javascript" src="<?php echo CMS_INCLUDES_RELATIVE_PATH; ?>fancybox/jquery.fancybox.js?v=2.1.4">
</script>
<link rel="stylesheet" type="text/css"
    href="<?php echo CMS_INCLUDES_RELATIVE_PATH; ?>fancybox/jquery.fancybox.css?v=2.1.4" media="screen" />
<script>
...
$(document).ready(function() {
    ...
    $.validator.addMethod('ck_testemail', function(data) {
        ...
        if ($('#send_to_insol_member').prop("checked") == false && $.trim($("#test_email").val()) ==
            "" && $('#test_group_email').prop("checked") == false && checked_governance.length ==
            parseInt(0)) {
            return false;
    ...
    $("#frm").validate({
        ...
        submitHandler: function() {
            ...
            $.ajax({
                ...
                data: "type=sendNewsletter&send_to_governance=" + checked_governance + "&" +
                    value,

                beforeSend: function() {

                    $("#INPROCESS").html(
                        "<div id='inprocess'><input type='button' value='Processing' class='process' /></div>"
                    );
                },
                        ...
                        setTimeout(function() {
                            ...
                            if (parseInt(spl_txt[1]) == parseInt(1)) {
                                window.location.href =
                                    "<?php echo "send-general-upload.php"; ?>?nid=<?php echo $ID;?>";
...
<form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
    ...
    <h1>
        General Newsletter Preview <div class="addProductBox"><a href="<?php echo PAGE_LIST;?>" class="backBtn">Go to
                List</a></div>
    </h1>
        ...
        <div class="containerPad">
            <div class="fullWidth noGap">
                <div class="width2">
                    ...
                    <input type="text" class="txtBox" name="general_newsletter_subject" id="general_newsletter_subject"
                        value="<?php echo $general_newsletter_subject; ?>" maxlength="100" autocomplete="OFF" />
                </div>
                <div class="width2">
                    <label class="mainLabel">Send To Test Mail <span>*</span> <small>[ Multiple email separated by comma
                            ]</small></label>
                    <input type="text" class="txtBox" name="test_email" id="test_email"
                        value="<?php echo $test_email; ?>" autocomplete="OFF" />
                </div>
            </div>
            <div class="fullWidth noGap">
                ...
                <div class="width24 memberH" style="min-height:auto !important; margin-bottom:0px;">
                    <label class="checkBoxWidth" style="width:100%;"><input type="checkbox" name="send_to_insol_member"
                            id="send_to_insol_member" value="1"
                            <?php if($send_to_insol_member ==1 ) { echo "checked"; }?> />Insol Member </label>
                </div>
                <?php
              $SQL_G  = "";
                ...
                <div class="width24 memberH" style="min-height:auto !important; margin-bottom:0px;" id="governance_id">
                    ...
                    <label class="checkBoxWidth" style="width:100%;"><input type="checkbox" name="send_to_governance[]"
                            id="send_to_governance_<?php echo $type_id; ?>"
                            value="<?php echo $type_id; ?>" /><?php echo $type_name; ?></label>
                </div>
                <?php
                    }
                 } 
                ?>
                <div class="width24 memberH" style="min-height:auto !important; margin-bottom:0px;">
                    <label class="checkBoxWidth" style="width:100%;"><input type="checkbox" name="test_group_email"
                            id="test_group_email" value="1" />Mailing List</label>
                </div>
                <div class="width24 memberH" style="min-height:auto !important; margin-bottom:0px;">
                    <label class="checkBoxWidth" style="width:100%;"><input type="checkbox" name="send_to_all_insol"
                            id="send_to_all_insol" value="1" />Send to all insol member</label>
                </div>
            ...
            <div class="fullWidth noGap">
                ...
                <div class="collapse" id="collapseExample">
                    <div class="width2">
                        <label class="mainLabel">Event Name <span>*</span> </label>
                        <input type="text" class="txtBox" name="eventName" id="" value="" autocomplete="OFF" />
                    </div>
                    <div class="width2">
                        <label class="mainLabel">Event Venue</label>
                        <input type="text" class="txtBox" name="eventVenue" id="" value="" autocomplete="OFF" />
                    </div>
                    <div class="width2">
                        <label class="mainLabel">Event Start Date</label>
                        <input type="text" class="txtBox" name="eventSDate" id="event_start_date" value=""
                            autocomplete="OFF" />
                    </div>
                    <div class="width2">
                        <label class="mainLabel">Event Start Time</label>
                        <div class='input-group date'>
                            <input type='text' id='datetimepicker3' name="eventSTime" class="txtBox form-control" />
                    ...
                    <div class="width2">
                        <label class="mainLabel">Event End Date</label>
                        <input type="text" class="txtBox" name="eventEDate" id="event_end_date" value=""
                            autocomplete="OFF" />
                    </div>
                    <div class="width2">
                        <label class="mainLabel">Event End Time</label>
                        <div class='input-group date'>
                            <input type='text' id='datetimepicker4' name="eventETime" class="txtBox form-control" />
                            <span class="input-group-addon">
                                <span class="glyphicon glyphicon-time"></span>
                            </span>
                        </div>
...
<div align="right" style="margin-bottom: 16px;">
    ...
    <a href="javascript:void(0);" ID="<?php echo $ID; ?>" class="print_detail" title="Print"><img border="0"
            src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH; ?>print-icon.png" border="0" alt="Print"></a>
</div>
<!-------to print-->
