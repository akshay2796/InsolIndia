...
define("PAGE_LIST","newsletter_sponsor_list.php");
?> 
...
<h1>Newsletter Sponsor List <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>" class="backBtn">Add New</a></div></h1>
