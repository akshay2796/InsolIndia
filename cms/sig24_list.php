...
$(document).ready(function(){
    ...
    function loadUrl()
    {
        ...
        var search_company_name = queryString['search_company_name'] || "";
        var search_fdate = queryString['search_fdate'] || "";    
        var search_tdate = queryString['search_tdate'] || "";
                   
        
        var search_val = "search_company_name=" + search_company_name;
...
$(function() {
    ...
    $('#search_fdate').datepick({
    	...
    	yearRange: '2014:<?php echo date("Y", strtotime('+10 year')); ?>'
    });  
...
<h1>SIG 24 List <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>" class="backBtn">Add New</a></div></h1>
        ...
        <form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
            <div class="fullWidth noGap">
                <div class="width4">
                    ...
                    <input type="text" class="txtBox" name="search_company_name" id="search_company_name" value="" maxlength="100"/>
                </div>
