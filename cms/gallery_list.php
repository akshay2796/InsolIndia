...
<h1>Gallery List <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>" class="backBtn">Add New</a></div></h1>
        ...
        <form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
            <div class="fullWidth noGap">
                ...
                <div class="width4">
                    ...
                    <div class="txt2Box">
                        <input type="text" class="txtBox hw" id="search_fdate" name="search_fdate" value=""  placeholder="" />
                    </div>
                </div>                
