...
$(document).ready(function(){
    ...
    function loadUrl()
    {
        ...
        var search_news_title = queryString['search_news_title'] || "";
        var search_fdate = queryString['search_fdate'] || "";    
        var search_tdate = queryString['search_tdate'] || "";
                   
        
        var search_val = "search_news_title=" + search_news_title;
    ...
    $.fn.displayOnTop = function() {
       ...
       // alert(ID + " ============ "+VAL);
        ...
        $.ajax({
               type: "POST",
               url: "<?php echo PAGE_AJAX; ?>",
               data: "type=displayOnTop&ID=" + ID + "&VAL="+VAL,
        	   beforeSend: function(){
                    $("#INPROCESS_SETDISPLAY_2_" + ID).hide();
                    $("#INPROCESS_SETDISPLAY_1_" + ID).show();
                    $("#INPROCESS_SETDISPLAY_1_" + ID).html("<img src='<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH; ?>loader-small.gif' border='0' />");
               ...
               success: function(msg){ 
                    ...
                    $("#INPROCESS_SETDISPLAY_1_" + ID).html("<div id='inprocess' class='del_msg'><div id='" + colorStyle + "' >"+spl_txt[2]+"</div></div>");
                    
                    setTimeout(function(){
                        
                         $("#INPROCESS_SETDISPLAY_1_" + ID).hide();
                         $("#INPROCESS_SETDISPLAY_2_" + ID).html("");
                         
                         var TL = "";
                         var IM = "";
                         
                         if ( $.trim(VAL) == parseInt(0) )
                         {
                            VL = parseInt(1);
                            TL = "Click to Set";
                         ...
                         var dw = "";
                         dw = dw + '<a href="javascript:void(0);" value="' + ID + '" myvalue="' + VL + '" class="displayOnTop">';
                         dw = dw + IM;
                         dw = dw + '</a>';
                         
                         //alert(dw);
                         $("#INPROCESS_SETDISPLAY_2_" + ID).html(dw);
                         $("#INPROCESS_SETDISPLAY_2_" + ID).show(); 
...
<h1>News List <div class="addProductBox"><a href="<?php echo PAGE_MAIN;?>" class="backBtn">Add New</a></div></h1>
        ...
        <form id="frm" name="frm" method="post" action="" enctype="multipart/form-data">
            <div class="fullWidth noGap">
                <div class="width4">
                    ...
                    <input type="text" class="txtBox" name="search_news_title" id="search_news_title" value="" maxlength="100"/>
                </div>
