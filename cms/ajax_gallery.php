                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" border='0'>
                        ...
                        ?>     
                            ...
                            <tr class="expiredCoupons trhover">
                                ...
                                <td align="center">
                                   <div id="INPROCESS_STATUS_1_<?php echo $gallery_id; ?>" style="display: none;"></div>
                                    <div id="INPROCESS_STATUS_2_<?php echo $gallery_id; ?>"  >
                                        <a href="javascript:void(0);" value="<?php  echo $gallery_id; ?>" myvalue="<?php echo $STATUSnowaction; ?>" class="setStatus">
                                            <img 
                                            <?php 
                                ...
                                <td>
                                	<h3 class="couponType">
                                        <a class="previewBookReview" href="javascript: void(0);" bid=<?php echo $gallery_id; ?>><?php echo $gallery_name; ?></a>
                                   </h3>
                                </td>  
                                <td>
                                ...
                                <td align="center">
                                    ...
                                    <div id="INPROCESS_HOME_2_<?php echo $gallery_id; ?>"  >
                                        <a href="javascript:void(0);" value="<?php echo $gallery_id; ?>" myvalue="<?php echo $HOMEPAGEnowaction; ?>" class="setHomePage">
                                            <img 
                                            <?php 
                                ...
                                */ ?>
                                ...
                                <td align="center" >
                                   ...
                                   <div id="INPROCESS_DELETE_2_<?php echo $gallery_id; ?>"  >
                                        <a href="<?php echo PAGE_MAIN; ?>?ID=<?php echo base64_encode(intval($gallery_id)); ?>" class="modifyData img_btn">
