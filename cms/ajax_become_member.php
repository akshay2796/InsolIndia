...
function saveData()
{
    ...
    if ($renewal_start_date != $old_renewal_start_date || $renewal_end_date != $old_renewal_end_date || $renewal_payment_text != $old_renewal_payment_detail) {
        $membership_starts_date = $renewal_start_date;
        $membershipExpiredDate = $renewal_end_date;
    }
    ...
    if ($con == "add") {
        ...
        if (intval($CHK) == intval(0)) {
            ...
            if (strtoupper($payment_status) == 'SUCCESSFUL' && strtoupper($old_payment_status) != 'SUCCESSFUL') {
                ...
                if ($renewal_end_date != "") {
                    $membership_start_date = $renewal_start_date;
                }
...
function editData()
{
    ...
    if ($renewal_end_date != "") {
        $membership_start_date = $renewal_start_date;
        $membership_expired_date = $renewal_end_date;
    }
...
//$mail->Password = "dOvb15^8";
    ...
    $query_up = "UPDATE tbl_become_member SET renewal_start_date = '$renewal_start_date',renewal_end_date ='$renewal_end_date', renewal_payment_detail = '$renewal_payment_text' membership_start_date = '$renewal_start_date' membership_expired_date = '$renewal_end_date'  WHERE member_id = $member_id";
    ...
    switch ($rs) {
        ...
        default:
            ...
            echo "~~~0~~~Sorry cannot process your request2";
            break;
    }
        ...
        $(document).ready(function() {
            ...
            $("#chk_all").click(function() {
                ...
                if (parseInt(nock) == parseInt(0)) {
                    $(".delete_all").attr("disabled", true).removeClass("submit_btn").addClass(
                        "grey_btn");
                    $(".export_all").attr("disabled", true).removeClass("submit_btn").addClass(
                        "grey_btn");
                } else {
                    $(".delete_all").attr("disabled", false).removeClass("grey_btn").css(
                        "background-color", "#BBBBBB").addClass("submit_btn");
                    $(".export_all").attr("disabled", false).removeClass("grey_btn").css(
                        "background-color", "#28B463").addClass("submit_btn");
                }
            ...
            $(".cb-element").click(function() {
                ...
                if (parseInt(nock) == parseInt(0)) {
                    $(".delete_all").attr("disabled", true).removeClass("submit_btn").addClass(
                        "grey_btn");
                    $(".export_all").attr("disabled", true).removeClass("submit_btn").css(
                        "background-color", "#BBBBBB").addClass("grey_btn");
                } else {
...
if (strtoupper($payment_status) == "SUCCESSFUL") {
                ?>
                            <div style='color:#18A15D;font-size: 11px;'> <i class="fa fa-key"></i>
...
if ($sig_member == intval(1)) {
                ?>
                            <img src="<?php echo CMS_INCLUDES_ICON_RELATIVE_PATH; ?>active.png" title="SIG Member"
                                alt="SIG Member" /></a>
                            <?php
} else {
                echo "&nbsp";
...
if (strtoupper($payment_status) == "SUCCESSFUL") {
                ...
                ?>
                            ...
                            <div><a href="javascript:void(0);" id="<?php echo $member_id; ?>" class="send_mail"
...
if (strtolower($register_status) == "approved") {
                ...
                if ($sig_member == intval(0)) {
                    ?>
                            <div id="INPROCESS_MAIL"><a href="javascript:void(0);" id="<?php echo $member_id; ?>"
                ...
                ?>
                            <div id="INPROCESS_MAIL">
                                ...
                                <input name="expmail" style="border: 0;background: #fff;color: #D9414D;"
                                    id="<?php echo $member_id; ?>"
                                    formaction="expiredmail.php?member_id=<?php echo $member_id; ?>" type="submit"
                                    value="send mail" />
                                <div id="INPROCESS_ERROR"></div>
                                <?php
// }
            ...
            ?>
                        ...
                        <td align="center">
                            ...
                            <div id="INPROCESS_DELETE_2_<?php echo $member_id; ?>">
                                ...
                                <a href="javascript:void(0);" id="<?php echo $member_id; ?>" class="img_btn view_detail"
                                    title="View Details"><img border="0"
                                ...
                                <a href="<?php if (strtolower($add_by) == 'admin') {echo EDIT_MAIN;} else {echo EDIT_MAIN;}?>?con=modify&id=<?php echo $member_id; ?>"
                                    class="img_btn viewDetail modi" title="Modify">
...
" class="grey_btn delete_all" value="Delete Selected" id="delete_all" disabled="" />
                <input name="frexp" formaction="main_export.php" class="grey_btn export_all" type="submit"
                    value="Export Selected" disabled="" />
            </td>
        </tr>
