...
function saveData()
{
    ...
    $webinar = trustme($_REQUEST['show_in_front']);
    $past_event = trustme($_REQUEST['past_event']);
    ...
    if($con == "add")
    {
        ...
        if( intval($CHK) == intval(0) )
        {
            ...
            $sINS->bindParam(":webinar", $webinar);
            $sINS->bindParam(":past_event", $past_event);
    ...
    else if($con == "modify")
    {
        ...
        { 
            ...
            */
            ...
            $sUPD->bindParam(":webinar", $webinar);
            $sUPD->bindParam(":past_event", $past_event);
