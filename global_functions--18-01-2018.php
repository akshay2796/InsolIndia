                ...
                <td bgcolor='#eaeaea' align='center'>
                    <table width='848' border='0' cellspacing='0' cellpadding='0' align='center' style='font-family: arial; border: 1px solid #EAEAEA;'>
                        <tbody>
                            ...
                            <tr>
                                <td valign='top' bgcolor='#fff' style='padding: 20px 25px 10px;'>

                                <h1 bgcolor='#fff' style='font-weight: bold; font-size: 20px; margin:0px; padding:0px;'>Dear ";$mMAIL .= $person_name . ",<br>Welcome to INSOL India Newsletter Volume ".$volume_name.", Issue ".$newsletter_issue." | ".$newsletter_date."</h1></td>
                            </tr>
                			<tr>
                    ...
                    <table width='848' border='0' cellspacing='0' cellpadding='0' align='center' style='font-family: arial; border: 1px solid #EAEAEA;'>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <h1 bgcolor='#fff' style='font-weight: bold; font-size: 20px; margin:0px; padding:0px;'>Dear ";$mMAIL .= $p_name . "</h1></td>
                            </tr>
                            <tr>
