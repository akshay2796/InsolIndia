...
<head>
    ...
    <title>INSOL Focus Webinar: Forum shopping and challenges in the recognition of insolvency proceedings: Some views
        from the bench - Choose Registration</title>
...
<![endif]-->
    ...
    <link type="text/css" rel="stylesheet" href="/ereg/include/datepicker/css/jquery.dateselect.css" />
    ...
    <link type="text/css" rel="stylesheet" href="/ereg/include/pickadate/themes/default.time.css" />
    ...
    td.questionInput select:not([class^=picker]) {
        background: ivory url(/ereg/include/img/select-arw.png) 97% 50% no-repeat
    }
    ...
    @media (min-width:801px) {
        ...
        html td.questionInput select:not([class^=picker]) {
            ...
            border-bottom-width: 1px;
            border-radius: 0;
            background: ivory url(/ereg/include/img/select-arw.png) 98% 50% no-repeat;
            color: #2f2f2f;
            font-size: 12px;
            font-weight: 400;
            text-indent: 1px;
...
<body class="index"><a href="#maincontentaccessible" class="skipaccessible">Skip to Main Content</a>
            ...
            <td class="new-desktop-nav"
                ...
                <div id="r-breadcrumbs" class="r-mobile" class="r-mobile" role="navigation" aria-label=”Progress”><span
                    ...
                    <ul class="crumbs" role="application"><span role="button" tabindex="0" aria-label="navigation menu"
                        ...
                        <li class="on"><a href="#" aria-current="page">Welcome</a></li>
                ...
                <table width="100%" cellspacing="0" cellpadding="2" id="orig-nav" class="r-desktop" role="navigation">
                    <tr>
                        <td align="center" width="33%" class="on">Welcome</td>
        ...
        <td class="reg-header-cont-cont">
            <table data-relatedvars="header-bg-color,table-header-color" width="100%" cellspacing="0" cellpadding="2"
                ...
                <table width="100%" cellspacing="0" cellpadding="2" class="reg-header-container">
                    <tr>
                        <td class="header reg-header-header"><?php echo $event_name . ": " . $event_title; ?></td>
                    </tr>
                </table>
        </td>
    </tr>
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top">
                        ...
                        <p align="center" class="r-reg-buttons"
                            ...
                            <input name="reg_button" type="button" class="button r-button"
                                style="display:inline-block !important;"
                                onclick="window.location.href='newreg.php?eventid=<?php echo $event_id; ?>'"
                                value="New Registration" />&nbsp<input name="reg_button" type="button"
                                class="button r-button" style="display:inline-block !important;"
                                onclick="window.location.href='modifyreg.php?eventid=200225862&'"
    ...
    <script type="text/javascript" src="/ereg/include/pickadate/picker.js"></script>
    <script type="text/javascript" src="/ereg/include/pickadate/picker.date.js"></script>
    <script type="text/javascript" src="/ereg/include/pickadate/picker.time.js"></script>
    <script type="text/javascript" src="/ereg/include/pickadate/legacy.js"></script>
    ...
    <input type='hidden' name='backbuttonCategory' id='backbuttonCategory' value=''><input type='hidden'
        ...
        id='backbtnLink' value=''><input type='hidden' name='backRegButtonVal' id='backRegButtonVal' value='Back'>
    <script type="text/javascript" src="/ereg/include/scripts/create_back_button.js"></script>
</body>
